...
- 13.2 bya: [One of the oldest stars](https://en.wikipedia.org/wiki/HE_1523-0901) in the [Milky Way](https://en.wikipedia.org/wiki/Milky_Way) galaxy formed
- 12.8 bya: The [galactic bulge](https://en.wikipedia.org/wiki/Galactic_bulge) of the [Milky Way](https://en.wikipedia.org/wiki/Milky_Way) galaxy formed
- 11.9-10.8 bya: [Quasar](https://en.wikipedia.org/wiki/Quasar) activity peaked

## < 10 Billion Years Ago

- 8.8 bya: The [thin disk](https://en.wikipedia.org/wiki/Thin_disk) of the [Milky Way](https://en.wikipedia.org/wiki/Milky_Way) galaxy formed
...
- 94 mya: [Euarchontoglires](https://en.wikipedia.org/wiki/Euarchontoglires) (Supraprimates) split from [Laurasiatheria](https://en.wikipedia.org/wiki/Laurasiatheria) (bats, carnivores, ungulates, etc.)
...
- 86 mya: [Scrotifera](https://en.wikipedia.org/wiki/Scrotifera) (e.g. bats, carnivores, and ungulates) split from [Eulipotyphla](https://en.wikipedia.org/wiki/Eulipotyphla) (insectivores such as hedgehogs, moles, and shrews)
...
- 24 kya: [Ancestral Native Americans (ANA)](https://en.wikipedia.org/wiki/Genetic_history_of_indigenous_peoples_of_the_Americas) migrated along [Beringia](https://en.wikipedia.org/wiki/Beringia)'s coastline, and inhabited the [Bluefish Caves](https://en.wikipedia.org/wiki/Bluefish_Caves)
...
- 21 kya: [Humans walked through what is now White Sands National Park](https://www.usgs.gov/programs/climate-research-and-development-program/news/discovery-ancient-human-footprints-white)
...
- 13 kya: The [Laacher See eruption](https://en.wikipedia.org/wiki/Laacher_See) occurred in present day Germany, with a [volcanic explosivity index (VEI)](https://en.wikipedia.org/wiki/Volcanic_explosivity_index) of 6
- 13 kya: The [Clovis peoples](https://en.wikipedia.org/wiki/Clovis_culture) inhabited what is now New Mexico
...
- 11.6 kya: [Beringia](https://en.wikipedia.org/wiki/Beringia)'s ice-free corridor between the [Cordilleran](https://en.wikipedia.org/wiki/Cordilleran_ice_sheet) and [Laurentide](https://en.wikipedia.org/wiki/Laurentide_ice_sheet) ice sheets supported enough plants and wildlife for [Ancestral Native Americans (ANA)](https://en.wikipedia.org/wiki/Genetic_history_of_indigenous_peoples_of_the_Americas) to use it
- 11.4 kya: People cultivated the earliest known seedless figs at [Gilgal I](https://en.wikipedia.org/wiki/Gilgal_I), near Jericho
...
- 1460 BCE: The [Taupō volcano erupted](https://en.wikipedia.org/wiki/Horomatangi_Reef) on New Zealand's North Island, with a [volcanic explosivity index (VEI)](https://en.wikipedia.org/wiki/Volcanic_explosivity_index) of 6
...
- 100 CE: [Xu Shen](https://en.wikipedia.org/wiki/Xu_Shen) compiled the [*Shuowen Jiezi*](https://en.wikipedia.org/wiki/Shuowen_Jiezi), a Chinese dictionary
...
- 602 CE: [Maurice](https://en.wikipedia.org/wiki/Maurice_%28emperor%29) wrote his [*Strategikon*](https://en.wikipedia.org/wiki/Strategikon_of_Maurice), a manual of war, by the time he died
...
- 1269 CE: [Petrus Peregrinus de Maricourt](https://en.wikipedia.org/wiki/Petrus_Peregrinus_de_Maricourt) wrote his *Epistola de magnete* (*Letter on the Magnet*), describing magnetic polarity, and the [magnetic compass](https://en.wikipedia.org/wiki/Compass)
...
- 1286 CE: [John Balbi](https://en.wikipedia.org/wiki/John_Balbi) wrote the *Summa grammaticalis quae vocatur Catholicon* (*The grammatical summary which is called Catholicon*), a Latin dictionary
...
- 1483 CE: The [Toledo School of Translators](https://en.wikipedia.org/wiki/Toledo_School_of_Translators) published the [*Alfonsine Tables*](https://en.wikipedia.org/wiki/Alfonsine_tables), data for computing the positions of the Sun, Moon, and planets
...
- 1500 CE: [Desiderius Erasmus](https://en.wikipedia.org/wiki/Erasmus) published [*Collectanea Adagiorum*, his first collection of adages](https://en.wikipedia.org/wiki/Adagia)
...
- 1503 CE: [Gregor Reisch](https://en.wikipedia.org/wiki/Gregor_Reisch) published the *Margarita Philosophica*, an [encyclopedia](https://en.wikipedia.org/wiki/Encyclopedia) explaining the [7 liberal arts](https://en.wikipedia.org/wiki/Liberal_arts_education#Seven_liberal_arts)
...
- 1508 CE: [Desiderius Erasmus](https://en.wikipedia.org/wiki/Erasmus) published [*Adagiorum chiliades tres* (*Three thousands of proverbs*)](https://en.wikipedia.org/wiki/Adagia)
...
- 1511 CE: [Desiderius Erasmus](https://en.wikipedia.org/wiki/Erasmus) published *Moriae Encomium* (*In Praise of Folly*)
- 1512 CE: [Desiderius Erasmus](https://en.wikipedia.org/wiki/Erasmus) published [*De Utraque Verborum ac Rerum Copia* (*On the Abundance of Both Words and Things*), a.k.a. *Copia: Foundations of the Abundant Style*](https://en.wikipedia.org/wiki/Copia:_Foundations_of_the_Abundant_Style), a rhetoric textbook
- 1521 CE: [Niccolò Machiavelli](https://en.wikipedia.org/wiki/Niccol%C3%B2_Machiavelli) published [*Dell'arte della guerra* (*The Art of War*)](https://en.wikipedia.org/wiki/The_Art_of_War_%28Machiavelli_book%29)
...
- 1525 CE: [Desiderius Erasmus](https://en.wikipedia.org/wiki/Erasmus) published [*Lingua* (*Language*)](https://en.wikipedia.org/wiki/Works_of_Erasmus#The_Tongue_%28or_Language%29_%281525%29)
- 1526 CE: [Gonzalo Fernández de Oviedo y Valdés](https://en.wikipedia.org/wiki/Gonzalo_Fern%C3%A1ndez_de_Oviedo_y_Vald%C3%A9s) published *La Natural hystoria de las Indias* (*The Natural History of the Indies*), introducing Europeans to the [hammock](https://en.wikipedia.org/wiki/Hammock), [pineapple](https://en.wikipedia.org/wiki/Pineapple), [tobacco](https://en.wikipedia.org/wiki/Tobacco), and [barbecue](https://en.wikipedia.org/wiki/Barbecue)
- 1530 CE: [Desiderius Erasmus](https://en.wikipedia.org/wiki/Erasmus) published [*De civilitate morum puerilium* (*On the civility of childish manners*), a.k.a. *On Civility in Children*](https://en.wikipedia.org/wiki/On_Civility_in_Children)
- 1531 CE: [Halley's Comet](https://en.wikipedia.org/wiki/Halley%27s_Comet) passed near the Earth
- 1531 CE: [Niccolò Machiavelli](https://en.wikipedia.org/wiki/Niccol%C3%B2_Machiavelli) posthumously published [*Discorsi sopra la prima deca di Tito Livio* (*Discourses on the First Ten of Titus Livy*)](https://en.wikipedia.org/wiki/Discourses_on_Livy)
- 1532 CE: [Niccolò Machiavelli](https://en.wikipedia.org/wiki/Niccol%C3%B2_Machiavelli) posthumously published [*Il Principe* (*The Prince*)](https://en.wikipedia.org/wiki/The_Prince)
- 1532 CE: [Niccolò Machiavelli](https://en.wikipedia.org/wiki/Niccol%C3%B2_Machiavelli) posthumously published his [*Istorie Fiorentine* (*Florentine Histories*)](https://en.wikipedia.org/wiki/Florentine_Histories)
- 1535 CE: [Gonzalo Fernández de Oviedo y Valdés](https://en.wikipedia.org/wiki/Gonzalo_Fern%C3%A1ndez_de_Oviedo_y_Vald%C3%A9s) published *Historia general de las Indias* (*General history of the Indies*)
...
- 1539 CE: [Olaus Magnus](https://en.wikipedia.org/wiki/Olaus_Magnus) published the [*Carta marina et descriptio septentrionalium terrarum* (*Marine map and description of the Northern lands*)](https://en.wikipedia.org/wiki/Carta_marina)
- 1541 CE: [Alonzo de Santa Cruz](https://en.wikipedia.org/wiki/Alonzo_de_Santa_Cruz) published the [*Islario general de todas las islas del mundo* (*General island directory of all the islands in the world*)](https://en.wikipedia.org/wiki/Islario_General)
...
- 1551 CE: [Erasmus Reinhold](https://en.wikipedia.org/wiki/Erasmus_Reinhold) published his [*Tabulae Prutenicae* (*Prutenic Tables*)](https://en.wikipedia.org/wiki/Prutenic_Tables), a star catalog
...
- 1555 CE: [Olaus Magnus](https://en.wikipedia.org/wiki/Olaus_Magnus) published [*Historia de Gentibus Septentrionalibus* (*History of the Northern Nations*), a.k.a. *A Description of the Northern Peoples*](https://en.wikipedia.org/wiki/A_Description_of_the_Northern_Peoples)
...
- 1595 CE: [Jan Huyghen van Linschoten](https://en.wikipedia.org/wiki/Jan_Huyghen_van_Linschoten) published *Reys-gheschrift vande navigatien der Portugaloysers in Orienten* (*Travel Accounts of Portuguese Navigation in the Orient*), describing sailing routes to Asia and details about its cultures such as drinking tea
- 1596 CE: [Jan Huyghen van Linschoten](https://en.wikipedia.org/wiki/Jan_Huyghen_van_Linschoten) published *Itinerario: Voyage ofte schipvaert van Jan Huygen van Linschoten naer Oost ofte Portugaels Indien, 1579-1592* (*Travel account of the voyage of the sailor Jan Huygen van Linschoten to the Portuguese East India*), describing sailing routes from Europe to the East Indies and life in Goa
...
- 1615 CE: Mei Yingzuo published the [*Zihui*](https://en.wikipedia.org/wiki/Zihui), a Chinese dictionary
- 1617 CE: [John Napier](https://en.wikipedia.org/wiki/John_Napier) posthumously published *Rabdologiæ seu Numerationis per Virgulas* (*Rabdology or Numeration by Commas*), describing [Napier's bones](https://en.wikipedia.org/wiki/Napier%27s_bones), a manual calculator for multiplication and division
- 1619 CE: [John Napier](https://en.wikipedia.org/wiki/John_Napier) posthumously published [*Mirifici Logarithmorum Canonis Constructio* (*Construction of the Wonderful Canon of Logarithms*)](https://en.wikipedia.org/wiki/Mirifici_Logarithmorum_Canonis_Descriptio), describing how he wrote his earlier book on [logarithms](https://en.wikipedia.org/wiki/Logarithm)
...
- 1627 CE: [Johannes Kepler](https://en.wikipedia.org/wiki/Johannes_Kepler) published the [*Rudolphine Tables*](https://en.wikipedia.org/wiki/Rudolphine_Tables), a [star catalog](https://en.wikipedia.org/wiki/Star_catalogue) containing observations by [Tycho Brahe](https://en.wikipedia.org/wiki/Tycho_Brahe)
- 1627 CE: Zhang Zilie published the [*Zhengzitong* (*Correct Character Mastery*)](https://en.wikipedia.org/wiki/Zhengzitong), a supplement to the [*Zihui*](https://en.wikipedia.org/wiki/Zihui) dictionary
- 1628 CE: [William Harvey](https://en.wikipedia.org/wiki/William_Harvey) published [*Exercitatio Anatomica de Motu Cordis et Sanguinis in Animalibus* (*Anatomical Account of the Motion of the Heart and Blood in Animals*)](https://en.wikipedia.org/wiki/Exercitatio_Anatomica_de_Motu_Cordis_et_Sanguinis_in_Animalibus), describing how the heart pumps blood through the body
...
- 1636 CE: [Pierre de Fermat](https://en.wikipedia.org/wiki/Pierre_de_Fermat) circulated his manuscript *Methodus ad disquirendam maximam et minimam et de tangentibus linearum curvarum* (*A method for discussing maximum and minimum and the tangents of curves*), contributing to [analytic geometry](https://en.wikipedia.org/wiki/Analytic_geometry) and [differential calculus](https://en.wikipedia.org/wiki/Differential_calculus), which [René Descartes](https://en.wikipedia.org/wiki/Ren%C3%A9_Descartes) read
...
- 1639 CE: [Blaise Pascal](https://en.wikipedia.org/wiki/Blaise_Pascal) published *Essai pour les coniques* (*Essay on conics*), stating [Pascal's theorem](https://en.wikipedia.org/wiki/Pascal%27s_theorem)
- 1639 CE: [Bernabé Cobo](https://en.wikipedia.org/wiki/Bernab%C3%A9_Cobo) wrote [*Historia de la fundación de Lima* (*History of the foundation of Lima*)](https://www.google.com/books/edition/Historia_de_la_fundaci%C3%B3n_de_Lima/opOPx386EzYC?hl=en)
...
- 1642 CE: [Blaise Pascal](https://en.wikipedia.org/wiki/Blaise_Pascal) invented [a mechanical calculator](https://en.wikipedia.org/wiki/Pascal%27s_calculator)
...
- 1653 CE: [Bernabé Cobo](https://en.wikipedia.org/wiki/Bernab%C3%A9_Cobo) wrote [*Historia general de las Indias* (*General history of the Indies*)](https://www.google.com/books/edition/Historia_del_Nuevo_mundo/UykCAAAAYAAJ?hl=en)
...
- 1657 CE: [Frans van Schooten](https://en.wikipedia.org/wiki/Frans_van_Schooten) published a translation of [Christiaan Huygens](https://en.wikipedia.org/wiki/Christiaan_Huygens)' *Van Rekeningh in Spelen van Gluck* (*Of Account in Games of Luck*), titled *De Ratiociniis in Ludo Aleae* (*The Reasons About Gambling*)
...
- 1659 CE: [Christiaan Huygens](https://en.wikipedia.org/wiki/Christiaan_Huygens) wrote *De vi centrifuga*, describing [centrifugal force](https://en.wikipedia.org/wiki/Centrifugal_force) and [centripetal](https://en.wikipedia.org/wiki/Centripetal_force) forces
...
- 1662 CE: [Pierre de Fermat](https://en.wikipedia.org/wiki/Pierre_de_Fermat) wrote a letter to [Marin Cureau de la Chambre](https://en.wikipedia.org/wiki/Marin_Cureau_de_la_Chambre) stating the [principle of least time](https://en.wikipedia.org/wiki/Fermat%27s_principle)
...
- 1663 CE: [Blaise Pascal](https://en.wikipedia.org/wiki/Blaise_Pascal) published *Traitez de l'Equilibre des Liqueurs* (*Treatise on the Equilibrium of Fluids*), establishing his [principle of transmission of fluid-pressure](https://en.wikipedia.org/wiki/Pascal%27s_law)
...
- 1672 CE: [Giovanni Domenico Cassini](https://en.wikipedia.org/wiki/Giovanni_Domenico_Cassini) published *Observations astronomiques faites en divers endroits du royaume, pendant l'année 1672* (*Astronomical observations made in various places of the kingdom, during the year 1672*), computing the parallax of Mars with [Jean Richer](https://en.wikipedia.org/wiki/Jean_Richer), and then the [distance from the Earth to the Sun](https://en.wikipedia.org/wiki/Astronomical_unit)
- 1673 CE: [Christiaan Huygens](https://en.wikipedia.org/wiki/Christiaan_Huygens) published [*Horologium Oscillatorium* (*The Pendulum Clock*)](https://en.wikipedia.org/wiki/Horologium_Oscillatorium), describing [his invention](https://en.wikipedia.org/wiki/Pendulum_clock) of the most accurate timepiece to date and until the 1930s
...
- 1679 CE: [Jean Richer](https://en.wikipedia.org/wiki/Jean_Richer) published *Observations Astronomiques Et Physiques Faites En L'Isle De Caienne* (*Astronomical and Physical Observations Made in the Island of Caïenne by M. Richer, of the Royal Academy of Sciences*), founding [gravimetry](https://en.wikipedia.org/wiki/Gravimetry)
- 1679 CE: [Pierre de Fermat](https://en.wikipedia.org/wiki/Pierre_de_Fermat) posthumously published *Ad Locos Planos et Solidos Isagoge* (*Introduction to Plane and Solid Loci*), earlier circulated as *Methodus ad disquirendam maximam et minimam et de tangentibus linearum curvarum* (*A method for discussing maximum and minimum and the tangents of curves*), which contributed to [analytic geometry](https://en.wikipedia.org/wiki/Analytic_geometry) and [differential calculus](https://en.wikipedia.org/wiki/Differential_calculus)
...
- 1689 CE: [John Locke](https://en.wikipedia.org/wiki/John_Locke) published [*Two Treatises of Government*](https://en.wikipedia.org/wiki/Two_Treatises_of_Government), attacking [absolute monarchy](https://en.wikipedia.org/wiki/Patriarchalism), and promoting [natural rights](https://en.wikipedia.org/wiki/Natural_rights_and_legal_rights) and the [social contract](https://en.wikipedia.org/wiki/Social_contract)
- 1690 CE: [John Locke](https://en.wikipedia.org/wiki/John_Locke) published [*An Essay Concerning Human Understanding*](https://en.wikipedia.org/wiki/An_Essay_Concerning_Human_Understanding), promoting [empiricism](https://en.wikipedia.org/wiki/Empiricism), and proposing a theory of [personal identity](https://en.wikipedia.org/wiki/Personal_identity)
- 1690 CE: [Christiaan Huygens](https://en.wikipedia.org/wiki/Christiaan_Huygens) published [*Traité de la Lumière* (*Treatise on Light*)](https://en.wikipedia.org/wiki/Treatise_on_Light), proposing the [wave theory of light](https://en.wikipedia.org/wiki/Physical_optics)
...
- 1696 CE: [Guillaume de l'Hôpital](https://en.wikipedia.org/wiki/Guillaume_de_l'H%C3%B4pital) published [Johann Bernoulli](https://en.wikipedia.org/wiki/Johann_Bernoulli)'s work on [differential calculus](https://en.wikipedia.org/wiki/Differential_calculus) in [*Analyse des Infiniment Petits pour l'Intelligence des Lignes Courbes* (*Analysis of the infinitely small to understand curves*)](https://en.wikipedia.org/wiki/Analyse_des_infiniment_petits_pour_l%27intelligence_des_lignes_courbes), introducing [l'Hôpital's rule](https://en.wikipedia.org/wiki/L'H%C3%B4pital's_rule)
...
- 1707 CE: [William Whiston](https://en.wikipedia.org/wiki/William_Whiston) published *Arithmetica Universalis* (*Universal Arithmetic*), based on [Isaac Newton](https://en.wikipedia.org/wiki/Isaac_Newton)'s lecture notes without his permission
...
- 1713 CE: [Jacob Bernoulli](https://en.wikipedia.org/wiki/Jacob_Bernoulli) published *Ars Conjectandi* (*The Art of Conjecturing*), deriving the [law of large numbers (LLN)](https://en.wikipedia.org/wiki/Law_of_large_numbers), and presenting [Bernoulli numbers](https://en.wikipedia.org/wiki/Bernoulli_number)
- 1716 CE: The [Kangxi Emperor](https://en.wikipedia.org/wiki/Kangxi_Emperor) published the *Kāngxī zìdiǎn* (*Kangxi Dictionary*)
...
- 1725 CE: [John Flamsteed](https://en.wikipedia.org/wiki/John_Flamsteed) posthumously published *Historia Coelestis Britannica*, the most accurate star catalog to date
...
- 1729 CE: [John Flamsteed](https://en.wikipedia.org/wiki/John_Flamsteed) posthumously published [*Atlas Coelestis*](https://en.wikipedia.org/wiki/Atlas_Coelestis), the first celestial atlas produced using the telescope
...
- 1749 CE: [Roger Joseph Boscovich](https://en.wikipedia.org/wiki/Roger_Joseph_Boscovich) published *De determinanda orbita planetae ope catoptricae ex datis vi celeritate & directione motus in dato puncto* (*On determining the orbits of a planet by the aid of catoptrics/reflections from given force speed and direction of motion in a given point*)
- 1750 CE: [John Michell](https://en.wikipedia.org/wiki/John_Michell) published *A Treatise of Artificial Magnets*, describing a method of producing artificial magnets
...
- 1752 CE: [Benjamin Franklin](https://en.wikipedia.org/wiki/Benjamin_Franklin) published *The [Kite Experiment](https://en.wikipedia.org/wiki/Kite_experiment)*, describing how to build a kite to obtain electricity from a thunder cloud, and asserting that static electricity and lightning are examples of the same phenomenon, leading him to invent the [lightning rod](https://en.wikipedia.org/wiki/Lightning_rod)
...
- 1753 CE: [Roger Joseph Boscovich](https://en.wikipedia.org/wiki/Roger_Joseph_Boscovich) published *De lunae atmosphaera* (*On the atmosphere of the moon*), arguing that the Moon does not have one
...
- 1755 CE: [Benjamin Franklin](https://en.wikipedia.org/wiki/Benjamin_Franklin) published [*Observations Concerning the Increase of Mankind, Peopling of Countries, etc.*](https://en.wikipedia.org/wiki/Observations_Concerning_the_Increase_of_Mankind,_Peopling_of_Countries,_etc.), an influential study of [demography](https://en.wikipedia.org/wiki/Demography) predicting exponential population growth in the 13 colonies
- 1755 CE: [Samuel Johnson](https://en.wikipedia.org/wiki/Samuel_Johnson) published [*A Dictionary of the English Language*](https://en.wikipedia.org/wiki/A_Dictionary_of_the_English_Language)
- 1756 CE: [Émilie du Châtelet](https://en.wikipedia.org/wiki/%C3%89milie_du_Ch%C3%A2telet) posthumously published a French translation of [Newton](https://en.wikipedia.org/wiki/Isaac_Newton)'s [*Principia*](https://en.wikipedia.org/wiki/Philosophi%C3%A6_Naturalis_Principia_Mathematica), *Principes mathématiques de la philosophie naturelle par feue Madame la Marquise du Châtelet* (*Mathematical principles of natural philosophy by the late Madame la Marquise du Châtelet*), including an analysis of [Willem 's Gravesande](https://en.wikipedia.org/wiki/Willem_%27s_Gravesande)'s 1722 experiment proving the [law of conservation of energy](https://en.wikipedia.org/wiki/Conservation_of_energy)
...
- 1758 CE: [Roger Joseph Boscovich](https://en.wikipedia.org/wiki/Roger_Joseph_Boscovich) published *Philosophiæ naturalis theoria redacta ad unicam legem virium in natura existentium* (*Theory of Natural philosophy derived to the single Law of forces which exist in Nature*), promoting [atomic theory](https://en.wikipedia.org/wiki/Atomic_theory)
...
- 1760 CE: [John Michell](https://en.wikipedia.org/wiki/John_Michell) published *Conjectures concerning the Cause and Observations upon the Phaenomena of Earthquakes*, describing earthquakes as waves in the Earth
...
- 1765 CE: [Leonhard Euler](https://en.wikipedia.org/wiki/Leonhard_Euler) published *De motu rectilineo trium corporum se mutuo attrahentium* (*The rectilinear motion of the three bodies attracting one another*), describing the three collinear [Lagrange points](https://en.wikipedia.org/wiki/Lagrange_point)
...
- 1766 CE: [Benjamin Franklin](https://en.wikipedia.org/wiki/Benjamin_Franklin) published *On the Price of Corn, and Management of the poor*
...
- 1767 CE: [Joseph Priestley](https://en.wikipedia.org/wiki/Joseph_Priestley) published [*The History and Present State of Electricity*](https://en.wikipedia.org/wiki/The_History_and_Present_State_of_Electricity)
...
- 1769 CE: [Benjamin Franklin](https://en.wikipedia.org/wiki/Benjamin_Franklin) published [*Experiments and Observations on Electricity*](https://en.wikipedia.org/wiki/Experiments_and_Observations_on_Electricity), including his 1758 letter to John Lining [*Cooling by Evaporation*](https://founders.archives.gov/documents/Franklin/01-08-02-0023)
...
- 1770 CE: [Benjamin Franklin](https://en.wikipedia.org/wiki/Benjamin_Franklin) & Timothy Folger named the [Gulf Stream](https://en.wikipedia.org/wiki/Gulf_Stream) ocean current and published a chart showing its course in the North Atlantic
- 1772 CE: [Joseph-Louis Lagrange](https://en.wikipedia.org/wiki/Joseph-Louis_Lagrange) published *Essai sur le Probléme des trois corps* (*Essay on the [three body problem](https://en.wikipedia.org/wiki/Three-body_problem)*), describing all 5 [Lagrange points](https://en.wikipedia.org/wiki/Lagrange_point) of equilibrium between orbiting bodies
- 1772 CE: [Benjamin Franklin](https://en.wikipedia.org/wiki/Benjamin_Franklin) wrote a letter to [Joseph Priestley](https://en.wikipedia.org/wiki/Joseph_Priestley) describing a [list of pros and cons](https://en.wikipedia.org/wiki/Decisional_balance_sheet)
- 1772 CE: [Joseph Priestley](https://en.wikipedia.org/wiki/Joseph_Priestley) published *Directions for Impregnating Water with Fixed Air*, describing a method of producing [carbonated water](https://en.wikipedia.org/wiki/Carbonated_water)
- 1773 CE: [Joseph-Louis Lagrange](https://en.wikipedia.org/wiki/Joseph-Louis_Lagrange) published *Mémoire sur l'utilité de la méthode* (*Dissertation on the usefulness of the method*), exploring [probability density functions](https://en.wikipedia.org/wiki/Probability_density_function)
- 1773 CE: [Joseph-Louis Lagrange](https://en.wikipedia.org/wiki/Joseph-Louis_Lagrange) published *Sur l'attraction des sphéroïdes elliptiques* (*On the attraction of elliptical spheroids*), describing [Gauss's law of electromagnetism](https://en.wikipedia.org/wiki/Gauss%27s_law)
- 1774 CE: [Pierre-Simon Laplace](https://en.wikipedia.org/wiki/Pierre-Simon_Laplace) published *Mémoire sur la probabilité des causes par les événements* (*Memoir on the probability of causes by events*)
...
- 1775 CE: [Joseph Priestley](https://en.wikipedia.org/wiki/Joseph_Priestley) published *An Account of further Discoveries in Air*, describing his discovery of oxygen
...
- 1783 CE: [John Michell](https://en.wikipedia.org/wiki/John_Michell) published *On the Means of Discovering the Distance, Magnitude, &c. of the Fixed Stars, in Consequence of the Diminution of the Velocity of Their Light, in Case Such a Diminution Should be Found to Take Place in any of Them, and Such Other Data Should be Procured from Observations, as Would be Farther Necessary for That Purpose*, proposing [black holes](https://en.wikipedia.org/wiki/Black_hole)
...
- 1783 CE: [Noah Webster](https://en.wikipedia.org/wiki/Noah_Webster) published *The First Part of the Grammatical Institute of the English Language*, a.k.a. the "Blue-Backed Speller"
...
- 1786 CE: [Noah Webster](https://en.wikipedia.org/wiki/Noah_Webster) published *The American Spelling Book*, a.k.a. the "Blue-Backed Speller"
...
- 1788 CE: [Joseph-Louis Lagrange](https://en.wikipedia.org/wiki/Joseph-Louis_Lagrange) published [*Mécanique analytique* (*Analytical mechanics*)](https://en.wikipedia.org/wiki/M%C3%A9canique_analytique), employing [infinitesimal numbers](https://en.wikipedia.org/wiki/Infinitesimal), and using [generalized coordinates](https://en.wikipedia.org/wiki/Generalized_coordinates) to deduce the [mechanics](https://en.wikipedia.org/wiki/Mechanics) of both solids and fluids, also presenting the [method of Lagrange multipliers](https://en.wikipedia.org/wiki/Lagrange_multiplier) and [principle of least action](https://en.wikipedia.org/wiki/Stationary-action_principle)
...
- 1789 CE: [Noah Webster](https://en.wikipedia.org/wiki/Noah_Webster) published his [*Dissertation on the English Language*](https://en.wikipedia.org/wiki/Dissertation_on_the_English_Language)
...
- 1794 CE: [Joseph Proust](https://en.wikipedia.org/wiki/Joseph_Proust) published *Recherches sur le Bleu de Prusse* (*Research on Prussian Blue*), describing the [law of definite proportions](https://en.wikipedia.org/wiki/Law_of_definite_proportions) in chemical compounds
- 1794 CE: [Elizabeth Fulhame](https://en.wikipedia.org/wiki/Elizabeth_Fulhame) published *An Essay On Combustion with a View to a New Art of Dying and Painting, wherein the Phlogistic and Antiphlogistic Hypotheses are Proved Erroneous*, describing [catalysis](https://en.wikipedia.org/wiki/Catalysis), [reduction–oxidation (redox)](https://en.wikipedia.org/wiki/Redox), and [photoreduction](https://en.wikipedia.org/wiki/Light-dependent_reactions)
...
- 1796 CE: [Pierre-Simon Laplace](https://en.wikipedia.org/wiki/Pierre-Simon_Laplace) published *Exposition du système du monde* (*World System Exhibition*)
...
- 1797 CE: [Joseph-Louis Lagrange](https://en.wikipedia.org/wiki/Joseph-Louis_Lagrange) published *Théorie des fonctions analytiques* (*Analytic function theory*), using the [generality of algebra](https://en.wikipedia.org/wiki/Generality_of_algebra) to explore [differential calculus](https://en.wikipedia.org/wiki/Differential_calculus)
...
- 1802 CE: [Pierre-Simon Laplace](https://en.wikipedia.org/wiki/Pierre-Simon_Laplace) published volume 3 of [*Traité de mécanique céleste* (*Treatise of celestial mechanics*)](https://en.wikipedia.org/wiki/Trait%C3%A9_de_m%C3%A9canique_c%C3%A9leste)
...
- 1806 CE: [Noah Webster](https://en.wikipedia.org/wiki/Noah_Webster) published [*A Compendious Dictionary of the English Language*](https://en.wikisource.org/wiki/A_Compendious_Dictionary_of_the_English_Language)
...
- 1809 CE: [Carl Friedrich Gauss](https://en.wikipedia.org/wiki/Carl_Friedrich_Gauss) published *Theoria motus corporum coelestium in sectionibus conicis solem ambientum* (*Theory of motion of the celestial bodies moving in conic sections around the Sun*), introducing the [Gaussian gravitational constant](https://en.wikipedia.org/wiki/Gaussian_gravitational_constant)
...
- 1812 CE: [Pierre-Simon Laplace](https://en.wikipedia.org/wiki/Pierre-Simon_Laplace) published *Théorie analytique des probabilités* (*Analytic Theory of Probability*), exploring [statistics](https://en.wikipedia.org/wiki/Statistics) and [probability](https://en.wikipedia.org/wiki/Probability)
...
- 1813 CE: [Jöns Jacob Berzelius](https://en.wikipedia.org/wiki/J%C3%B6ns_Jacob_Berzelius) published *Essay on the Cause of Chemical Proportions, and on some Circumstances relating to them: together with a short and easy Method of expressing them*, supporting [atomic theory](https://en.wikipedia.org/wiki/Atomic_theory) and [Proust](https://en.wikipedia.org/wiki/Joseph_Proust)'s [law of definite proportions](https://en.wikipedia.org/wiki/Law_of_definite_proportions), and introducing [modern chemical notation](https://en.wikipedia.org/wiki/Chemical_formula)
- 1813 CE: [Mathieu Orfila](https://en.wikipedia.org/wiki/Mathieu_Orfila) published *Traité des poisons* (*Treatise on poisons*)
...
- 1814 CE: [Pierre-Simon Laplace](https://en.wikipedia.org/wiki/Pierre-Simon_Laplace) published *Essai philosophique sur les probabilités* (*Philosophical essay on probability*), exploring [generating functions](https://en.wikipedia.org/wiki/Generating_function) and [probability theory](https://en.wikipedia.org/wiki/Probability_theory), demonstrating the [Laplace transform](https://en.wikipedia.org/wiki/Laplace_transform) and [inductive reasoning](https://en.wikipedia.org/wiki/Inductive_reasoning)
...
- 1820 CE: [Joseph Fourier](https://en.wikipedia.org/wiki/Joseph_Fourier) published *Sur l'usage du théorème de Descartes dans la recherche des limites des racines* (*On the use of Descartes' theorem in the search for the limits of roots*), introducing [Fourier's theorem on polynomial real roots](https://en.wikipedia.org/wiki/Budan%27s_theorem#Fourier's_theorem)
...
- 1821 CE: [Augustin-Louis Cauchy](https://en.wikipedia.org/wiki/Augustin-Louis_Cauchy) published [*Cours d'Analyse* (*Analysis Course*)](https://en.wikipedia.org/wiki/Cours_d%27Analyse), rejecting the [generality of algebra](https://en.wikipedia.org/wiki/Generality_of_algebra) and promoting [infinitesimals](https://en.wikipedia.org/wiki/Infinitesimal) instead, introduced rigorous analysis, and defined [limits](https://en.wikipedia.org/wiki/Limit_of_a_function)
...
- 1821 CE: [Carl Friedrich Gauss](https://en.wikipedia.org/wiki/Carl_Friedrich_Gauss) invented the [heliotrope](https://en.wikipedia.org/wiki/Heliotrope_%28instrument%29)
...
- 1822 CE: [Joseph Fourier](https://en.wikipedia.org/wiki/Joseph_Fourier) published *Théorie analytique de la chaleur* (*The Analytical Theory of Heat*), introducing the [heat equation](https://en.wikipedia.org/wiki/Heat_equation), [Fourier transform (FT)](https://en.wikipedia.org/wiki/Fourier_transform), and asserting the importance of [dimensional homogeneity](https://en.wikipedia.org/wiki/Dimensional_analysis#Dimensional_homogeneity)
...
- 1823 CE: [Siméon Denis Poisson](https://en.wikipedia.org/wiki/Sim%C3%A9on_Denis_Poisson) published *Mémoire sur la théorie du magnétisme en mouvement* (*Memoir on the theory of magnetism in motion*), introducing [Poisson's equation for electrostatic and gravitational fields](https://en.wikipedia.org/wiki/Poisson%27s_equation)
- 1824 CE: [Joseph Fourier](https://en.wikipedia.org/wiki/Joseph_Fourier) published *Remarques générales sur les températures du globe terrestre et des espaces planétaires* (*General notes on temperatures of the globe and planetary spaces*), describing the [greenhouse effect](https://en.wikipedia.org/wiki/Greenhouse_effect)
...
- 1824 CE: [William Buckland](https://en.wikipedia.org/wiki/William_Buckland) published *Notice on the Megalosaurus or great Fossil Lizard of Stonesfield*, the first correct identification of a [dinosaur](https://en.wikipedia.org/wiki/Dinosaur)
...
- 1825 CE: [Pierre-Simon Laplace](https://en.wikipedia.org/wiki/Pierre-Simon_Laplace) published volume 5 of [*Traité de mécanique céleste* (*Treatise of celestial mechanics*)](https://en.wikipedia.org/wiki/Trait%C3%A9_de_m%C3%A9canique_c%C3%A9leste)
- 1825 CE: [Gideon Mantell](https://en.wikipedia.org/wiki/Gideon_Mantell) published *Notice on the Iguanodon, a newly discovered fossil reptile, from the sandstone of Tilgate forest, in Sussex*, describing [Mary Ann Mantell](https://en.wikipedia.org/wiki/Mary_Ann_Mantell)'s discovery of the second known [dinosaur](https://en.wikipedia.org/wiki/Dinosaur)
- 1825 CE: [Augustin-Louis Cauchy](https://en.wikipedia.org/wiki/Augustin-Louis_Cauchy) published *Mémoire sur les intégrales définies, prises entre des limites imaginaires* (*A Memorandum on definite integrals taken between imaginary limits*), introducing [Cauchy's integral theorem](https://en.wikipedia.org/wiki/Cauchy%27s_integral_theorem) and [complex analysis](https://en.wikipedia.org/wiki/Complex_analysis)
- 1826 CE: [Augustin-Louis Cauchy](https://en.wikipedia.org/wiki/Augustin-Louis_Cauchy) published *Sur un nouveau genre de calcul analogue au calcul infinitésimal* (*On a new type of calculus analogous to the infinitesimal calculus*), defining the [residue of a complex function](https://en.wikipedia.org/wiki/Residue_%28complex_analysis%29)
...
- 1827 CE: [Georg Ohm](https://en.wikipedia.org/wiki/Georg_Ohm) published *Die galvanische Kette, mathematisch bearbeitet* (*The Galvanic Circuit Investigated Mathematically*), describing [Ohm's law](https://en.wikipedia.org/wiki/Ohm%27s_law)
- 1828 CE: [Carl Friedrich Gauss](https://en.wikipedia.org/wiki/Carl_Friedrich_Gauss) published *Bestimmung des Breitenunterschiedes zwischen den Sternwarten von Göttingen und Altona durch Beobachtungen am Ramsdenschen Zenithsector* (*Determination of the difference in latitude between the observatories of Göttingen and Altona through observations at Ramsden's zenith sector*), approximating the [geoid](https://en.wikipedia.org/wiki/Geoid)
- 1828 CE: [Carl Friedrich Gauss](https://en.wikipedia.org/wiki/Carl_Friedrich_Gauss) published his [*Theorema Egregium* (*Remarkable Theorem*)](https://en.wikipedia.org/wiki/Theorema_Egregium) describing [Gaussian curvature](https://en.wikipedia.org/wiki/Gaussian_curvature)
...
- 1828 CE: [George Green](https://en.wikipedia.org/wiki/George_Green_%28mathematician%29) published [*An Essay on the Application of Mathematical Analysis to the Theories of Electricity and Magnetism*](https://en.wikipedia.org/wiki/An_Essay_on_the_Application_of_Mathematical_Analysis_to_the_Theories_of_Electricity_and_Magnetism) introducing [Green's theorem](https://en.wikipedia.org/wiki/Green%27s_theorem)
- 1828 CE: [Noah Webster](https://en.wikipedia.org/wiki/Noah_Webster) published [*An American Dictionary of the English Language*](https://en.wikipedia.org/wiki/Webster%27s_Dictionary)
- 1829 CE: [Noah Webster](https://en.wikipedia.org/wiki/Noah_Webster) published *The Elementary Spelling Book*, a.k.a. the "Blue-Backed Speller"
- 1829 CE: [Augustin-Louis Cauchy](https://en.wikipedia.org/wiki/Augustin-Louis_Cauchy) published *Leçons sur le calcul différentiel*, defining a complex function of a complex variable
...
- 1829 CE: [Siméon Denis Poisson](https://en.wikipedia.org/wiki/Sim%C3%A9on_Denis_Poisson) published *Mémoire sur l'équilibre et le mouvement des corps élastiques* (*Memory on the balance and movement of elastic bodies*)
...
- 1831 CE: [Augustin-Louis Cauchy](https://en.wikipedia.org/wiki/Augustin-Louis_Cauchy) published *Sur la mecanique celeste et sur un nouveau calcul qui s'applique a un grand nombre de questions diverses etc* (*On Celestial Mechanics and on a new calculation which is applicable to a large number of diverse questions*), introducing [Cauchy's integral formula](https://en.wikipedia.org/wiki/Cauchy%27s_integral_formula)
- 1831 CE: [Augustin-Louis Cauchy](https://en.wikipedia.org/wiki/Augustin-Louis_Cauchy) published *Mémoire sur les rapports qui existent entre le calcul des Résidus et le calcul des Limites, et sur les avantages qu'offrent ces deux calculs dans la résolution des équations algébriques ou transcendantes* (*Memorandum on the connections that exist between the residue calculus and the limit calculus, and on the advantages that these two calculi offer in solving algebraic and transcendental equations*), introducing the [residue theorem](https://en.wikipedia.org/wiki/Residue_theorem)
- 1832 CE: [Jöns Jacob Berzelius](https://en.wikipedia.org/wiki/J%C3%B6ns_Jacob_Berzelius) published *Isomeri, dess distinktion från dermed analoga förhållanden* (*Isomerism, its distinction from thus analogous conditions*), coining the term [polymer](https://en.wikipedia.org/wiki/Polymer)
- 1832 CE: [Carl von Clausewitz](https://en.wikipedia.org/wiki/Carl_von_Clausewitz) posthumously published [*On War*](https://en.wikipedia.org/wiki/On_War)
...
- 1833 CE: [William Rowan Hamilton](https://en.wikipedia.org/wiki/William_Rowan_Hamilton) published *Introductory Lecture on Astronomy*, introducing [Hamiltonian mechanics](https://en.wikipedia.org/wiki/Hamiltonian_mechanics) as a reformulation of [Lagrangian mechanics](https://en.wikipedia.org/wiki/Lagrangian_mechanics)
- 1833 CE: [Siméon Denis Poisson](https://en.wikipedia.org/wiki/Sim%C3%A9on_Denis_Poisson) published his [*Traité de mécanique* (*Treatise on Mechanics*)](https://www.google.com/books/edition/A_Treatise_of_Mechanics/lksn7QwUZsQC), introducing the [Poisson bracket](https://en.wikipedia.org/wiki/Poisson_bracket)
...
- 1837 CE: [Siméon Denis Poisson](https://en.wikipedia.org/wiki/Sim%C3%A9on_Denis_Poisson) published *Recherches sur la probabilité des jugements en matière criminelle et en matière civile* (*Research on the probability of judgments in criminal and civil matters*), describing the [Poisson distribution](https://en.wikipedia.org/wiki/Poisson_distribution)
- 1838 CE: [Christoph Gudermann](https://en.wikipedia.org/wiki/Christoph_Gudermann) published *Theorie der Modular-Functionen und der Modular-Integrale* (*Theory of Modular Functions and Modular Integrals*), introducing the concept of [uniform convergence](https://en.wikipedia.org/wiki/Uniform_convergence)
...
- 1838 CE: [Gerardus Johannes Mulder](https://en.wikipedia.org/wiki/Gerardus_Johannes_Mulder) published *Sur la composition de quelques substances animales* (*On the composition of some animal substances*), using the term [protein](https://en.wikipedia.org/wiki/Protein) coined by [Berzelius](https://en.wikipedia.org/wiki/J%C3%B6ns_Jacob_Berzelius), and noting that nearly all proteins have the same [empirical formula](https://en.wikipedia.org/wiki/Empirical_formula), C<sub>400</sub>H<sub>620</sub>N<sub>100</sub>O<sub>120</sub>P<sub>1</sub>S<sub>1</sub>
...
- 1839 CE: [Michael Faraday](https://en.wikipedia.org/wiki/Michael_Faraday) published the final installment of *Experimental Researches in Electricity*, describing his [law of electromagnetic induction](https://en.wikipedia.org/wiki/Faraday%27s_law_of_induction)
- 1839 CE: [Edmond Becquerel](https://en.wikipedia.org/wiki/Edmond_Becquerel) published *Mémoire sur les effets électriques produits sous l'influence des rayons solaires* (*Memoir on the electrical effects produced under the influence of solar rays*), describing the [photovoltaic effect](https://en.wikipedia.org/wiki/Photovoltaic_effect) (i.e. solar panels)

### 1840s

- 1840 CE: [Louis Agassiz](https://en.wikipedia.org/wiki/Louis_Agassiz) published *Études sur les glaciers* (*Studies on Glaciers*)
- 1840 CE: [Carl Friedrich Gauss](https://en.wikipedia.org/wiki/Carl_Friedrich_Gauss) published *Dioptrische Untersuchungen* (*Dioptric examinations*), describing [Gaussian optics](https://en.wikipedia.org/wiki/Gaussian_optics)
...
- 1841 CE: [Jöns Jacob Berzelius](https://en.wikipedia.org/wiki/J%C3%B6ns_Jacob_Berzelius) published *Årsberättelse om Framstegen i Fysik och Kemi afgifven den 31 Mars 1840. Första delen* (*Annual Report on Progress in Physics and Chemistry submitted March 31, 1840. First part*), describing and coining the term [allotropy](https://en.wikipedia.org/wiki/Allotropy)
- 1841 CE: [James Prescott Joule](https://en.wikipedia.org/wiki/James_Prescott_Joule) published *On the Heat evolved by Metallic Conductors of Electricity, and in the Cells of a Battery during Electrolysis*, stating [Joule's first law](https://en.wikipedia.org/wiki/Joule_heating) that an electrical conductor generates heat proportional to its resistance multiplied by the current squared (P = I<sup>2</sup> R)
...
- 1843 CE: [James Prescott Joule](https://en.wikipedia.org/wiki/James_Prescott_Joule) published *On the Calorific Effects of Magneto-Electricity, and on the Mechanical Value of Heat*, stating that [heat is energy](https://en.wikipedia.org/wiki/Mechanical_equivalent_of_heat), arguing for [conservation of energy](https://en.wikipedia.org/wiki/Conservation_of_energy) and against [caloric theory](https://en.wikipedia.org/wiki/Caloric_theory)
...
- 1846 CE: [Augustin-Louis Cauchy](https://en.wikipedia.org/wiki/Augustin-Louis_Cauchy) published *Sur les intégrales qui s'étendent à tous les points d'une courbe fermée* (*On integrals that extend over all of the points of a closed curve*) refining [Green's theorem](https://en.wikipedia.org/wiki/Green%27s_theorem)
- 1847 CE: [Hermann von Helmholtz](https://en.wikipedia.org/wiki/Hermann_von_Helmholtz) published *Über die Erhaltung der Kraft* (*On the Conservation of Force*), arguing for [conservation of energy](https://en.wikipedia.org/wiki/Conservation_of_energy) and against [vital forces](https://en.wikipedia.org/wiki/Vitalism)
...
- 1850 CE: [Rudolf Clausius](https://en.wikipedia.org/wiki/Rudolf_Clausius) published *Ueber die bewegende Kraft der Wärme und die Gesetze, welche sich daraus für die Wärmelehre selbst ableiten lassen* (*On the moving Force of Heat and the Laws, that can be derived from it for the Theory of Heat itself*), stating the [second law of thermodynamics](https://en.wikipedia.org/wiki/Second_law_of_thermodynamics)
...
- 1850 CE: [John Tyndall](https://en.wikipedia.org/wiki/John_Tyndall) & [Hermann Knoblauch](https://en.wikipedia.org/wiki/Hermann_Knoblauch) published *The Magneto-Optic Properties of Crystals, and the Relation of Magnetism and Diamagnetism to Molecular Arrangement*
...
- 1853 CE: [Léon Foucault](https://en.wikipedia.org/wiki/L%C3%A9on_Foucault) published *Sur les vitesses relatives de la lumière dans l'air et dans l'eau* (*On the relative speeds of light in air and in water*), providing evidence against the [corpuscular theory of light](https://en.wikipedia.org/wiki/Corpuscular_theory_of_light)
- 1853 CE: [William Rowan Hamilton](https://en.wikipedia.org/wiki/William_Rowan_Hamilton) published *Lectures on [Quaternions](https://en.wikipedia.org/wiki/Quaternion)*, which are useful for [calculations involving three-dimensional rotations](https://en.wikipedia.org/wiki/Quaternions_and_spatial_rotation)
- 1853 CE: [Edmond Becquerel](https://en.wikipedia.org/wiki/Edmond_Becquerel) published *Researches on the electrical conductibility of gases at high temperatures*, describing [thermionic emission](https://en.wikipedia.org/wiki/Thermionic_emission)
...
- 1854 CE: [Rudolf Clausius](https://en.wikipedia.org/wiki/Rudolf_Clausius) published *Ueber eine veränderte Form des zweiten Hauptsatzes der mechanischen Wärmetheoriein* (*On a modified Form of the second Law of the mechanical Theory of Heat*), restating the [second law of thermodynamics](https://en.wikipedia.org/wiki/Second_law_of_thermodynamics) as "Heat can never pass from a colder to a warmer body without some other change, connected therewith, occurring at the same time."
...
- 1857 CE: [Alfred Russel Wallace](https://en.wikipedia.org/wiki/Alfred_Russel_Wallace) published *Proceedings of Natural-History Collectors in Foreign Countries*, describing the [Wallace Line](https://en.wikipedia.org/wiki/Wallace_Line) between Bali and Lombok
- 1857 CE: [Rudolf Clausius](https://en.wikipedia.org/wiki/Rudolf_Clausius) published *Über die Art der Bewegung, die wir Wärme nennen* (*On the Kind of Movement we call Heat*), introducing the concept of the [mean free path](https://en.wikipedia.org/wiki/Mean_free_path) of a particle
...
- 1858 CE: [Alfred Russel Wallace](https://en.wikipedia.org/wiki/Alfred_Russel_Wallace) published *On the Tendency of Varieties to Depart Indefinitely From the Original Type*
...
- 1860 CE: [John Tyndall](https://en.wikipedia.org/wiki/John_Tyndall) published [*The Glaciers of the Alps*](https://www.gutenberg.org/ebooks/34192)
...
- 1861 CE: [John Tyndall](https://en.wikipedia.org/wiki/John_Tyndall) published *On the Absorption and Radiation of Heat by Gases and Vapours*, showing that water vapor and CO₂ absorb heat [(the greenhouse effect)](https://en.wikipedia.org/wiki/Greenhouse_effect)
...
- 1863 CE: [Hermann von Helmholtz](https://en.wikipedia.org/wiki/Hermann_von_Helmholtz) published [*Die Lehre von den Tonempfindungen als physiologische Grundlage für die Theorie der Musik* (*On the Sensations of Tone as a Physiological Basis for the Theory of Music*)](https://en.wikipedia.org/wiki/Sensations_of_Tone), describing [Helmholtz resonance](https://en.wikipedia.org/wiki/Helmholtz_resonance)
...
- 1863 CE: [John Tyndall](https://en.wikipedia.org/wiki/John_Tyndall) published *Heat a Mode of Motion*
...
- 1865 CE: [Rudolf Clausius](https://en.wikipedia.org/wiki/Rudolf_Clausius) published *Ueber verschiedene für die Anwendung bequeme Formen der Hauptgleichungen der mechanischen Wärmetheorie* (*On various convenient forms of the main equations of the mechanical theory of heat*), coining the term [entropy](https://en.wikipedia.org/wiki/Entropy) and describing it mathematically, simply stated "The energy of the universe is constant. The entropy of the universe tends to a maximum."
...
- 1867 CE: [Hermann von Helmholtz](https://en.wikipedia.org/wiki/Hermann_von_Helmholtz) published *Handbuch der Physiologischen Optik* (*Handbook of Physiological Optics*), describing [unconscious inference](https://en.wikipedia.org/wiki/Unconscious_inference)
...
- 1867 CE: [John Tyndall](https://en.wikipedia.org/wiki/John_Tyndall) published [*Sound*](https://www.gutenberg.org/ebooks/54969)
...
- 1868 CE: [John Tyndall](https://en.wikipedia.org/wiki/John_Tyndall) published *On the Blue Colour of the Sky, the Polarization of Skylight, and on the Polarization of Light Diffused by Concurrently-made Media*, describing the [Tyndall effect](https://en.wikipedia.org/wiki/Tyndall_effect), explaining why the sky is blue
...
- 1871 CE: [John Tyndall](https://en.wikipedia.org/wiki/John_Tyndall) published [*Fragments of Science for Unscientific People*](https://www.gutenberg.org/ebooks/24527)
- 1871 CE: [John William Strutt](https://en.wikipedia.org/wiki/John_William_Strutt,_3rd_Baron_Rayleigh) published *On the light from the sky, its polarization and colour*, describing [Rayleigh scattering](https://en.wikipedia.org/wiki/Rayleigh_scattering) which is why the sky is blue
...
- 1872 CE: [Eduard Heine](https://en.wikipedia.org/wiki/Eduard_Heine) published *Die Elemente der Functionenlehre* (*The Elements of the Theory of Functions*), sharing Karl Weierstrass' formal definition of a [limit](https://en.wikipedia.org/wiki/Limit_of_a_function)
...
- 1873 CE: [John Tyndall](https://en.wikipedia.org/wiki/John_Tyndall) published [*Six Lectures on Light*](https://www.gutenberg.org/ebooks/14000)
...
- 1876 CE: [John Tyndall](https://en.wikipedia.org/wiki/John_Tyndall) published *Optical Purity and Air*, describing how floating dust particles carry germs, in favor of [germ theory of disease](https://en.wikipedia.org/wiki/Germ_theory_of_disease)
...
- 1877 CE: [Charles Sanders Peirce](https://en.wikipedia.org/wiki/Charles_Sanders_Peirce) published [*The Fixation of Belief*](https://en.wikisource.org/wiki/The_Fixation_of_Belief), founding [pragmatism](https://en.wikipedia.org/wiki/Pragmatism)
- 1877 CE: [John William Strutt](https://en.wikipedia.org/wiki/John_William_Strutt,_3rd_Baron_Rayleigh) published *On the Irregular Flight of a Tennis Ball*, describing his circulation theory of [aerodynamic lift](https://en.wikipedia.org/wiki/Lift_%28force%29)
...
- 1878 CE: [Josiah Willard Gibbs](https://en.wikipedia.org/wiki/Josiah_Willard_Gibbs) published [*On the Equilibrium of Heterogeneous Substances*](https://en.wikipedia.org/wiki/On_the_Equilibrium_of_Heterogeneous_Substances), founding [chemical thermodynamics](https://en.wikipedia.org/wiki/Chemical_thermodynamics), including [chemical potential](https://en.wikipedia.org/wiki/Chemical_potential), [transport phenomena](https://en.wikipedia.org/wiki/Transport_phenomena), and the [phase rule](https://en.wikipedia.org/wiki/Phase_rule)
...
- 1878 CE: [John William Strutt](https://en.wikipedia.org/wiki/John_William_Strutt,_3rd_Baron_Rayleigh) published *The Theory of Sound*
- 1879 CE: [John William Strutt](https://en.wikipedia.org/wiki/John_William_Strutt,_3rd_Baron_Rayleigh) published *On the Instability of Jets*
...
- 1879 CE: [John William Strutt](https://en.wikipedia.org/wiki/John_William_Strutt,_3rd_Baron_Rayleigh) published *Investigations in Optics, with special reference to the Spectroscope*, describing his criterion for angular resolution, specifically diffraction limits
...
- 1880 CE: [John William Strutt](https://en.wikipedia.org/wiki/John_William_Strutt,_3rd_Baron_Rayleigh) published *On the resultant of a large number of vibrations of the same pitch and of arbitrary phase*, introducing the [Rayleigh test](https://en.wikipedia.org/wiki/Rayleigh_test) for periodicity in irregularly sampled data, and the [Raleigh plot or circlegram](https://en.wikipedia.org/wiki/Raleigh_plot)
...
- 1881 CE: [John William Strutt](https://en.wikipedia.org/wiki/John_William_Strutt,_3rd_Baron_Rayleigh) published *On the electromagnetic theory of light*, describing how [Rayleigh scattering](https://en.wikipedia.org/wiki/Rayleigh_scattering) (why the sky is blue) follows from [Maxwell's equations](https://en.wikipedia.org/wiki/History_of_Maxwell's_equations)
...
- 1882 CE: [Bernabé Cobo](https://en.wikipedia.org/wiki/Bernab%C3%A9_Cobo) posthumously published [*Historia de la fundación de Lima* (*History of the foundation of Lima*)](https://www.google.com/books/edition/Historia_de_la_fundaci%C3%B3n_de_Lima/opOPx386EzYC?hl=en)
- 1882 CE: [Henri Poincaré](https://en.wikipedia.org/wiki/Henri_Poincar%C3%A9) published *Mémoire sur les courbes définies par une équation différentielle* (*On curves defined by differential equations*), introducing his [qualitative theory of differential equations](https://en.wikipedia.org/wiki/Qualitative_theory_of_differential_equations)
...
- 1883 CE: [Osborne Reynolds](https://en.wikipedia.org/wiki/Osborne_Reynolds) published *An experimental investigation of the circumstances which determine whether the motion of water shall be direct or sinuous, and of the law of resistance in parallel channels*, describing [Reynolds numbers](https://en.wikipedia.org/wiki/Reynolds_number) and the causes of [laminar](https://en.wikipedia.org/wiki/Laminar_flow) and [turbulent flow](https://en.wikipedia.org/wiki/Turbulence)
- 1883 CE: [John William Strutt](https://en.wikipedia.org/wiki/John_William_Strutt,_3rd_Baron_Rayleigh) published *Investigation of the character of the equilibrium of an incompressible heavy fluid of variable density*, describing [Rayleigh–Taylor instability](https://en.wikipedia.org/wiki/Rayleigh%E2%80%93Taylor_instability)
...
- 1884 CE: [Svante Arrhenius](https://en.wikipedia.org/wiki/Svante_Arrhenius) published *Recherches sur la conductibilite galvanique des electrolytes* (*Investigations on the Galvanic Conductivity of Electrolytes*)
- 1885 CE: [Charles Sanders Peirce](https://en.wikipedia.org/wiki/Charles_Sanders_Peirce) published *On the Algebra of Logic: A Contribution to the Philosophy of Notation*, stating [Peirce's law](https://en.wikipedia.org/wiki/Peirce%27s_law)
...
- 1885 CE: [John William Strutt](https://en.wikipedia.org/wiki/John_William_Strutt,_3rd_Baron_Rayleigh) published *On Waves Propagated along the Plane Surface of an Elastic Solid*, describing [Rayleigh waves](https://en.wikipedia.org/wiki/Rayleigh_wave)
...
- 1887 CE: [Svante Arrhenius](https://en.wikipedia.org/wiki/Svante_Arrhenius) published *Über die Dissociation der in Wasser gelösten Stoffe* (*On the Dissociation of Substances Dissolved in Water*), describing how salts dissociate into ions in water without an electric current, defining acids and bases, and laying a foundation for [physical chemistry](https://en.wikipedia.org/wiki/Physical_chemistry)
...
- 1888 CE: [John J. Loud](https://en.wikipedia.org/wiki/John_J._Loud) [patented](https://patents.google.com/patent/US2390636) the first [ballpoint pen](https://en.wikipedia.org/wiki/Ballpoint_pen)
...
- 1889 CE: [Oliver Heaviside](https://en.wikipedia.org/wiki/Oliver_Heaviside) published *On the electromagnetic effects due to the motion of electrification through a dielectric*, deriving the [Lorentz force](https://en.wikipedia.org/wiki/Lorentz_force)
- 1889 CE: [Svante Arrhenius](https://en.wikipedia.org/wiki/Svante_Arrhenius) published *Über die Dissociationswärme und den Einfluss der Temperatur auf den Dissociationsgrad der Elektrolyte* (*On the Heat of Dissociation and the Influence of Temperature on the Degree of Dissociation of Electrolytes*), describing his [equation for calculating activation energy](https://en.wikipedia.org/wiki/Arrhenius_equation)
...
- 1890 CE: [Bernabé Cobo](https://en.wikipedia.org/wiki/Bernab%C3%A9_Cobo) posthumously published [*Historia del Nuevo mundo* (*History of the New World*)](https://www.google.com/books/edition/Historia_del_Nuevo_mundo/UykCAAAAYAAJ?hl=en)
- 1890 CE: [Henri Poincaré](https://en.wikipedia.org/wiki/Henri_Poincar%C3%A9) published *Sur le problème des trois corps et les équations de la dynamique* (*On the [Three-Body Problem](https://en.wikipedia.org/wiki/Three-body_problem) and the Equations of Dynamics*), founding [chaos theory](https://en.wikipedia.org/wiki/Chaos_theory)
...
- 1891 CE: [Pierre de Fermat](https://en.wikipedia.org/wiki/Pierre_de_Fermat) posthumously published *Oeuvres de Fermat* (*Works by Fermat*) volume 1
- 1891 CE: The [Austro-Hungarian Empire](https://en.wikipedia.org/wiki/Austria-Hungary) published the [*Codex Alimentarius Austriacus* (*Austrian Food Code*)](https://en.wikipedia.org/wiki/Codex_Alimentarius_Austriacus), promoting food safety
...
- 1893 CE: [J. J. Thomson](https://en.wikipedia.org/wiki/J._J._Thomson) published *Notes on recent researches in electricity and magnetism*, building upon [Maxwell's *Treatise*](https://en.wikipedia.org/wiki/A_Treatise_on_Electricity_and_Magnetism)
...
- 1893 CE: [Oliver Heaviside](https://en.wikipedia.org/wiki/Oliver_Heaviside) published *The Elements of Vectorial Algebra and Analysis*, simplifying [Maxwell's equations](https://en.wikipedia.org/wiki/Maxwell%27s_equations) with [vector calculus](https://en.wikipedia.org/wiki/Vector_calculus)
...
- 1894 CE: [Pierre de Fermat](https://en.wikipedia.org/wiki/Pierre_de_Fermat) posthumously published *Oeuvres de Fermat* (*Works by Fermat*) volume 2, mentioning [Fermat's factorization method](https://en.wikipedia.org/wiki/Fermat%27s_factorization_method), [Fermat's little theorem](https://en.wikipedia.org/wiki/Fermat%27s_little_theorem), and [Pell's equation](https://en.wikipedia.org/wiki/Pell%27s_equation)
- 1894 CE: [Karl Weierstrass](https://en.wikipedia.org/wiki/Karl_Weierstrass) published *Abhandlungen-1* (*Treatises-1*), including *Zur Theorie der Potenzreihen* (*On the Theory of Power Series*), formally defining [uniform convergence](https://en.wikipedia.org/wiki/Uniform_convergence)
...
- 1895 CE: [Osborne Reynolds](https://en.wikipedia.org/wiki/Osborne_Reynolds) published *On the Dynamical Theory of Incompressible Viscous Fluids and the Determination of the Criterion*, introducing [Reynolds-averaged Navier–Stokes (RANS) equations](https://en.wikipedia.org/wiki/Reynolds-averaged_Navier%E2%80%93Stokes_equations) and [Reynolds operators](https://en.wikipedia.org/wiki/Reynolds_operator#CITEREFReynolds1895)
- 1895 CE: [Henri Poincaré](https://en.wikipedia.org/wiki/Henri_Poincar%C3%A9) published [*Analysis Situs* (*Site Analysis* or *Geometry of Position*)](https://en.wikipedia.org/wiki/Analysis_Situs_%28paper%29), founding [algebraic topology](https://en.wikipedia.org/wiki/Algebraic_topology)
- 1895 CE: [John William Strutt](https://en.wikipedia.org/wiki/John_William_Strutt,_3rd_Baron_Rayleigh) & [William Ramsay](https://en.wikipedia.org/wiki/William_Ramsay) published *[Argon](https://en.wikipedia.org/wiki/Argon), a New Constituent of the Atmosphere*, the third most abundant gas in [Earth's atmosphere](https://en.wikipedia.org/wiki/Atmosphere_of_Earth) (at nearly 1% by volume) after nitrogen (at 78%) and oxygen (at 21%)
...
- 1896 CE: [Ludwig Boltzmann](https://en.wikipedia.org/wiki/Ludwig_Boltzmann) published *Vorlesungen über Gastheorie* (*Lectures on Gas Theory*) volume 1, developing [statistical mechanics](https://en.wikipedia.org/wiki/Statistical_mechanics)
- 1896 CE: [Pierre de Fermat](https://en.wikipedia.org/wiki/Pierre_de_Fermat) posthumously published *Oeuvres de Fermat* (*Works by Fermat*) volume 3, containing many of his letters
- 1896 CE: [Svante Arrhenius](https://en.wikipedia.org/wiki/Svante_Arrhenius) published *On the Influence of Carbonic Acid in the Air upon the Temperature of the Ground*, predicting how atmospheric CO₂ would affect average surface temperature [(the greenhouse effect)](https://en.wikipedia.org/wiki/Greenhouse_effect)
...
- 1897 CE: [J. J. Thomson](https://en.wikipedia.org/wiki/J._J._Thomson) published *Cathode Rays*, describing [electron beams](https://en.wikipedia.org/wiki/Cathode_ray) and identifying the electron as a distinct particle
...
- 1898 CE: [Ludwig Boltzmann](https://en.wikipedia.org/wiki/Ludwig_Boltzmann) published *Vorlesungen über Gastheorie* (*Lectures on Gas Theory*) volume 2, further developing [statistical mechanics](https://en.wikipedia.org/wiki/Statistical_mechanics)
- 1898 CE: [John Ambrose Fleming](https://en.wikipedia.org/wiki/John_Ambrose_Fleming) published [*Magnets and Electric Currents*](https://www.google.com/books/edition/Magnets_and_Electric_Currents/ASUYAAAAYAAJ), introducing [Fleming's rules](https://en.wikipedia.org/wiki/Fleming%27s_rules), i.e. the [right-hand rule for electric generators](https://en.wikipedia.org/wiki/Fleming%27s_right-hand_rule) and [left-hand rule for electric motors](https://en.wikipedia.org/wiki/Fleming%27s_left-hand_rule_for_motors)
...
- 1899 CE: [John William Strutt](https://en.wikipedia.org/wiki/John_William_Strutt,_3rd_Baron_Rayleigh) published *On the transmission of light through an atmosphere containing small particles in suspension, and on the origin of the blue of the sky*, describing how [Rayleigh scattering](https://en.wikipedia.org/wiki/Rayleigh_scattering) (why the sky is blue) applies to individual molecules
...
- 1900 CE: [Louis Bachelier](https://en.wikipedia.org/wiki/Louis_Bachelier) defended his doctoral thesis *Théorie de la spéculation* (*The Theory of Speculation*), on introducing the [Bachelier model](https://en.wikipedia.org/wiki/Bachelier_model) of [Brownian motion](https://en.wikipedia.org/wiki/Brownian_motion)
- 1900 CE: [John William Strutt](https://en.wikipedia.org/wiki/John_William_Strutt,_3rd_Baron_Rayleigh) published *Remarks upon the Law of Complete Radiation*, describing the [Rayleigh–Jeans law](https://en.wikipedia.org/wiki/Rayleigh%E2%80%93Jeans_law) for classical [black-body radiation](https://en.wikipedia.org/wiki/Black-body_radiation)
...
- 1902 CE: [Karl Weierstrass](https://en.wikipedia.org/wiki/Karl_Weierstrass) posthumously published *Theorie der Abelschen Transcendenten* (*Theory of Abelian Transcendents*)
...
- 1902 CE: [Henri Poincaré](https://en.wikipedia.org/wiki/Henri_Poincar%C3%A9) published [*La Science et l'Hypothèse* (*Science and Hypothesis*)](https://en.wikipedia.org/wiki/Science_and_Hypothesis), promoting [conventionalism](https://en.wikipedia.org/wiki/Conventionalism)
- 1903 CE: [Konstantin Tsiolkovsky](https://en.wikipedia.org/wiki/Konstantin_Tsiolkovsky) published *Exploration of Outer Space with Reaction Devices*, describing his [rocket equation](https://en.wikipedia.org/wiki/Tsiolkovsky_rocket_equation)
- 1903 CE: [Karl Weierstrass](https://en.wikipedia.org/wiki/Karl_Weierstrass) posthumously published *Abhandlungen-3* (*Treatises-3*)
...
- 1903 CE: [Osborne Reynolds](https://en.wikipedia.org/wiki/Osborne_Reynolds) published *Papers on Mechanical and Physical Subjects*, introducing the [Reynolds transport theorem](https://en.wikipedia.org/wiki/Reynolds_transport_theorem)
...
- 1904 CE: [Ernst Zermelo](https://en.wikipedia.org/wiki/Ernst_Zermelo) published *Beweis, dass jede Menge wohlgeordnet werden kann* (*Proof that any quantity can be well-ordered*), formalizing the [well-ordering theorem](https://en.wikipedia.org/wiki/Well-ordering_theorem) and the [axiom of choice](https://en.wikipedia.org/wiki/Axiom_of_choice)
- 1904 CE: [Henri Poincaré](https://en.wikipedia.org/wiki/Henri_Poincar%C3%A9) published [*La Valeur de la Science* (*The Value of Science*)](https://en.wikipedia.org/wiki/The_Value_of_Science)
- 1905 CE: [Henri Poincaré](https://en.wikipedia.org/wiki/Henri_Poincar%C3%A9) published his short paper *Sur la dynamique de l'électron* (*On Electron Dynamics*), presenting the [Lorentz transformations](https://en.wikipedia.org/wiki/Lorentz_transformation) in their modern form, introducing [group theory](https://en.wikipedia.org/wiki/Group_theory) to physics, and proposing [gravitational waves](https://en.wikipedia.org/wiki/Gravitational_wave)
...
- 1905 CE: [John Ambrose Fleming](https://en.wikipedia.org/wiki/John_Ambrose_Fleming) patented an [*Instrument for converting alternating electric currents into continuous currents*](https://patents.google.com/patent/US803684), the [Fleming valve](https://en.wikipedia.org/wiki/Fleming_valve), the first practical [diode](https://en.wikipedia.org/wiki/Diode#Vacuum_tube_diodes) which he used to [detect radio waves](https://en.wikipedia.org/wiki/Detector_%28radio%29), and the first [electronic device](https://en.wikipedia.org/wiki/Electronics)
- 1905 CE: [Fritz Haber](https://en.wikipedia.org/wiki/Fritz_Haber) published *Thermodynamik technischer Gasreaktionen: Sieben Vorlesungen* (*Thermodynamics of Technical Gas Reactions: Seven Lectures*), describing the [Haber process](https://en.wikipedia.org/wiki/Haber_process) which produces ammonia from air, and today feeds half the world's population with food grown using artificial fertilizer
...
- 1907 CE: [Svante Arrhenius](https://en.wikipedia.org/wiki/Svante_Arrhenius) published *Immunochemistry*
- 1908 CE: [Svante Arrhenius](https://en.wikipedia.org/wiki/Svante_Arrhenius) published [*Worlds in the Making*](https://www.gutenberg.org/ebooks/69022)
...
- 1908 CE: [Lee de Forest](https://en.wikipedia.org/wiki/Lee_de_Forest) patented the [Audion](https://en.wikipedia.org/wiki/Audion), the first [triode](https://en.wikipedia.org/wiki/Triode) and first [electronic amplifier](https://en.wikipedia.org/wiki/Amplifier)
- 1908 CE: [Arnold Sommerfeld](https://en.wikipedia.org/wiki/Arnold_Sommerfeld) published *Ein Beitrag zur hydrodynamischen Erkläerung der turbulenten Flüssigkeitsbewegüngen* (*A Contribution to Hydrodynamic Explanation of Turbulent Fluid Motions*), coining the term [Reynolds number](https://en.wikipedia.org/wiki/Reynolds_number)
...
- 1910 CE: [John William Strutt](https://en.wikipedia.org/wiki/John_William_Strutt,_3rd_Baron_Rayleigh) published *Aerial plane waves of finite amplitudes*, describing [Rayleigh flow](https://en.wikipedia.org/wiki/Rayleigh_flow)
...
- 1911 CE: [Paul](https://en.wikipedia.org/wiki/Paul_Ehrenfest) & [Tatiana Ehrenfest](https://en.wikipedia.org/wiki/Tatyana_Afanasyeva) published [*Begriffliche Grundlagen der statistischen Auffassung in der Mechanik* (*The Conceptual Foundations of the Statistical Approach in Mechanics*)](https://openlibrary.org/books/OL7640602M/The_Conceptual_Foundations_of_the_Statistical_Approach_in_Mechanics_%28Dover_Phoneix_Editions%29), describing [statistical mechanics](https://en.wikipedia.org/wiki/Statistical_mechanics)
...
- 1912 CE: The [Novarupta eruption](https://en.wikipedia.org/wiki/Novarupta) occurred in present day Alaska, with a [volcanic explosivity index (VEI)](https://en.wikipedia.org/wiki/Volcanic_explosivity_index) of 6
...
- 1914 CE: [Henri Poincaré](https://en.wikipedia.org/wiki/Henri_Poincar%C3%A9) published *Science et méthode* (*Science and Method*)
...
- 1916 CE: [John William Strutt](https://en.wikipedia.org/wiki/John_William_Strutt,_3rd_Baron_Rayleigh) published *On Convection Currents in a Horizontal Layer of Fluid When the Higher Temperature Is on the Underside*, describing the [Rayleigh number](https://en.wikipedia.org/wiki/Rayleigh_number)
...
- 1917 CE: [John William Strutt](https://en.wikipedia.org/wiki/John_William_Strutt,_3rd_Baron_Rayleigh) published *On the Dynamics of Revolving Fluids*, describing his stability criterion for [Taylor–Couette flow](https://en.wikipedia.org/wiki/Taylor%E2%80%93Couette_flow)
...
- 1918 CE: [Svante Arrhenius](https://en.wikipedia.org/wiki/Svante_Arrhenius) published [*Das Schicksal der Planeten* (*The Destinies of the Stars*)](https://www.gutenberg.org/ebooks/58222)
...
- 1921 CE: [Norbert Wiener](https://en.wikipedia.org/wiki/Norbert_Wiener) published *The Average of an Analytic Functional and the Brownian Movement* introducing the [Wiener equation](https://en.wikipedia.org/wiki/Wiener_equation)
...
- 1922 CE: [Abraham Fraenkel](https://en.wikipedia.org/wiki/Abraham_Fraenkel) published *Zu den Grundlage der Cantor-Zermeloschen Mengenlehre* (*The foundations of Cantor-Zermelian set theory*), introducing the [axiom schema of replacement](https://en.wikipedia.org/wiki/Axiom_schema_of_replacement)
- 1922 CE: [Abraham Fraenkel](https://en.wikipedia.org/wiki/Abraham_Fraenkel) published *Über den Begriff 'definit' und die Unabhängigkeit des Auswahlaxioms* (*On the concept of 'definite' and the independence of the axiom of choice*), addressing ambiguity in Zermelo's notion of a "definite" [propositional function](https://en.wikipedia.org/wiki/Propositional_function)
...
- 1924 CE: [Harry Nyquist](https://en.wikipedia.org/wiki/Harry_Nyquist) published *Certain factors affecting telegraph speed*, introducing the [Nyquist–Shannon sampling theorem](https://en.wikipedia.org/wiki/Nyquist%E2%80%93Shannon_sampling_theorem)
- 1924 CE: [Albert Einstein](https://en.wikipedia.org/wiki/Albert_Einstein) translated and published [Satyendra Nath Bose](https://en.wikipedia.org/wiki/Satyendra_Nath_Bose)'s paper *Planck's Law and Hypothesis of Light Quanta* as *Plancks Gesetz und Lichtquantenhypothese*, founding [quantum statistics](https://en.wikipedia.org/wiki/Particle_statistics#Quantum_statistics)
- 1924 CE: [Louis de Broglie](https://en.wikipedia.org/wiki/Louis_de_Broglie) published *Recherches sur la théorie des quanta* (*Research on quantum theory*), introducing the idea that [matter behaves like a wave](https://en.wikipedia.org/wiki/Matter_wave)
...
- 1925 CE: [Leo Szilard](https://en.wikipedia.org/wiki/Leo_Szilard) published *Über die thermodynamischen Schwankungserscheinungen* (*On The Manifestation of Thermodynamic Fluctuations*), connecting [thermodynamics](https://en.wikipedia.org/wiki/Thermodynamics) with [information theory](https://en.wikipedia.org/wiki/Information_theory)
- 1925 CE: [Cecilia Payne](https://en.wikipedia.org/wiki/Cecilia_Payne-Gaposchkin) published [*Stellar Atmospheres; A Contribution to the Observational Study of High Temperature in the Reversing Layers of Stars*](https://articles.adsabs.harvard.edu//full/1925PhDT.........1P/0000001,006.html), proposing that stars mostly consist of hydrogen and helium
- 1925 CE: [Abraham Fraenkel](https://en.wikipedia.org/wiki/Abraham_Fraenkel) published *Untersuchungen über die Grundlagen der Mengenlehre* (*Investigations into the foundations of set theory*), comprehensively describing [Zermelo–Fraenkel axioms](https://en.wikipedia.org/wiki/Zermelo%E2%80%93Fraenkel_set_theory#Axioms)
...
- 1926 CE: [Hans Busch](https://en.wikipedia.org/wiki/Hans_Busch) published *Berechnung der Bahn von Kathodenstrahlen im axialsymmetrischen elektromagnetischen Felde* (*Calculation of the trajectory of cathode rays in an axisymmetric electromagnetic field*), describing the [electromagnetic lens](https://en.wikipedia.org/wiki/Transmission_electron_microscopy#Electron_lens)
- 1927 CE: [Karl Weierstrass](https://en.wikipedia.org/wiki/Karl_Weierstrass) posthumously published *Variationsrechnung* (*Calculus of Variations*)
...
- 1927 CE: [Jean Piaget](https://en.wikipedia.org/wiki/Jean_Piaget) published *La causalite physique chez l'enfant* (*The child's conception of physical causality*), introducing his [theory of cognitive development](https://en.wikipedia.org/wiki/Piaget%27s_theory_of_cognitive_development)
...
- 1928 CE: Marcellus Luther ("M. L.") & Joseph ("Joe") Jacobs incorporated the [Jacobs Wind Electric Company](https://en.wikipedia.org/wiki/Jacobs_Wind) producing [wind turbines](https://en.wikipedia.org/wiki/Windmill), using 3 blades to avoid the instability seen with 2 blades
- 1928 CE: [Leo Szilard](https://en.wikipedia.org/wiki/Leo_Szilard) submitted a patent for the [electron microscope](https://en.wikipedia.org/wiki/Electron_microscope)
- 1928 CE: [Leo Szilard](https://en.wikipedia.org/wiki/Leo_Szilard) submitted a patent for the [linear particle accelerator (a.k.a. linac)](https://en.wikipedia.org/wiki/Linear_particle_accelerator)
- 1928 CE: [Rolf Widerøe](https://en.wikipedia.org/wiki/Rolf_Wider%C3%B8e) published *Über Ein Neues Prinzip Zur Herstellung Hoher Spannungen* (*On a new principle for producing high voltages*), describing his implementation of [Gustav Ising](https://en.wikipedia.org/wiki/Gustav_Ising)'s idea for a [linear particle accelerator (a.k.a. linac)](https://en.wikipedia.org/wiki/Linear_particle_accelerator), using a resonance accelerator to accelerate particles with radio waves instead of high voltage
...
- 1929 CE: [Leo Szilard](https://en.wikipedia.org/wiki/Leo_Szilard) published *Über die Entropieverminderung in einem thermodynamischen System bei Eingriffen intelligenter Wesen* (*On the reduction of entropy in a thermodynamic system by the intervention of intelligent beings*), introducing [Szilard's engine](https://en.wikipedia.org/wiki/Entropy_in_thermodynamics_and_information_theory#Szilard's_engine) which later inspired [Claude Shannon](https://en.wikipedia.org/wiki/Claude_Shannon)
...
- 1929 CE: [V. Gordon Childe](https://en.wikipedia.org/wiki/V._Gordon_Childe) published *The Danube in Prehistory*, defining [archaeological culture](https://en.wikipedia.org/wiki/Archaeological_culture)
- 1930 CE: [V. Gordon Childe](https://en.wikipedia.org/wiki/V._Gordon_Childe) published *The Bronze Age*, asserting that metal-smiths were the first full-time professionals who lived off the [social surplus](https://en.wikipedia.org/wiki/Economic_surplus)
...
- 1930 CE: [Albert Einstein](https://en.wikipedia.org/wiki/Albert_Einstein) & [Leo Szilard](https://en.wikipedia.org/wiki/Leo_Szilard) patented the [Einstein refrigerator](https://en.wikipedia.org/wiki/Einstein_refrigerator), which uses no moving parts
- 1930 CE: [Cecilia Payne-Gaposchkin](https://en.wikipedia.org/wiki/Cecilia_Payne-Gaposchkin) published *The Stars of High Luminosity*, cataloging [variable stars](https://en.wikipedia.org/wiki/Variable_star) to determine [stellar evolution](https://en.wikipedia.org/wiki/Stellar_evolution)
...
- 1931 CE: [Ernst Zermelo](https://en.wikipedia.org/wiki/Ernst_Zermelo) published *Über das Navigationsproblem bei ruhender oder veränderlicher Windverteilung* (*On the navigation problem with stationary or changing wind distribution*), describing [Zermelo's navigation problem](https://en.wikipedia.org/wiki/Zermelo's_navigation_problem)
...
- 1932 CE: [Ernest Lawrence](https://en.wikipedia.org/wiki/Ernest_Lawrence) & [M. Stanley Livingston](https://en.wikipedia.org/wiki/M._Stanley_Livingston) published [*The Production of High Speed Light Ions Without the Use of High Voltages*](https://journals.aps.org/pr/abstract/10.1103/PhysRev.40.19), describing the [cyclotron particle accelerator](https://en.wikipedia.org/wiki/Cyclotron)
- 1932 CE: [Harry Nyquist](https://en.wikipedia.org/wiki/Harry_Nyquist) published *Regeneration theory*, describing the [Nyquist stability criterion](https://en.wikipedia.org/wiki/Nyquist_stability_criterion)
...
- 1933 CE: [Ernst Ruska](https://en.wikipedia.org/wiki/Ernst_Ruska) demonstrated an [electron microscope](https://en.wikipedia.org/wiki/Electron_microscope) with higher resolution than an optical microscope
...
- 1936 CE: [V. Gordon Childe](https://en.wikipedia.org/wiki/V._Gordon_Childe) published *Man Makes Himself*, describing the [Neolithic Revolution](https://en.wikipedia.org/wiki/Neolithic_Revolution) and [urban revolution](https://en.wikipedia.org/wiki/Urban_revolution)
- 1936 CE: [Lillian Rosanoff Lieber](https://en.wikipedia.org/wiki/Lillian_Rosanoff_Lieber) published *The Einstein Theory of Relativity*
...
- 1942 CE: [V. Gordon Childe](https://en.wikipedia.org/wiki/V._Gordon_Childe) published *What Happened in History*, a sequel to *Man Makes Himself*
- 1942 CE: [Lillian Rosanoff Lieber](https://en.wikipedia.org/wiki/Lillian_Rosanoff_Lieber) published *The Education of T. C. MITS*
- 1942 CE: [Norbert Wiener](https://en.wikipedia.org/wiki/Norbert_Wiener) published *Extrapolation, Interpolation and Smoothing of Stationary Time Series*, introducing the [Wiener filter](https://en.wikipedia.org/wiki/Wiener_filter)
...
- 1944 CE: [V. Gordon Childe](https://en.wikipedia.org/wiki/V._Gordon_Childe) published *Progress and Archaeology*, and *The Story of Tools*
- 1944 CE: [Enrico Fermi](https://en.wikipedia.org/wiki/Enrico_Fermi) & [Leo Szilard](https://en.wikipedia.org/wiki/Leo_Szilard) submitted a [patent](https://patents.google.com/patent/US2708656) for the first successful artificial nuclear reactor, [Chicago Pile-1](https://en.wikipedia.org/wiki/Chicago_Pile-1), which was tested in 1942
- 1944 CE: [John von Neumann](https://en.wikipedia.org/wiki/John_von_Neumann) & [Oskar Morgenstern](https://en.wikipedia.org/wiki/Oskar_Morgenstern) published their [*Theory of Games and Economic Behavior*](https://en.wikipedia.org/wiki/Theory_of_Games_and_Economic_Behavior), founding [game theory](https://en.wikipedia.org/wiki/Game_theory)
- 1944 CE: [Karl Popper](https://en.wikipedia.org/wiki/Karl_Popper) published [*The Poverty of Historicism*](https://en.wikipedia.org/wiki/The_Poverty_of_Historicism)
- 1945 CE: [Karl Popper](https://en.wikipedia.org/wiki/Karl_Popper) published [*The Open Society and Its Enemies*](https://en.wikipedia.org/wiki/The_Open_Society_and_Its_Enemies)
- 1945 CE: [John von Neumann](https://en.wikipedia.org/wiki/John_von_Neumann) published the [*First Draft of a Report on the EDVAC*](https://en.wikipedia.org/wiki/First_Draft_of_a_Report_on_the_EDVAC), describing the [von Neumann architecture](https://en.wikipedia.org/wiki/Von_Neumann_architecture)
...
- 1946 CE: [V. Gordon Childe](https://en.wikipedia.org/wiki/V._Gordon_Childe) published *Archaeology and Anthropology*, arguing that those disciplines should be used in tandem
- 1946 CE: [Lillian Rosanoff Lieber](https://en.wikipedia.org/wiki/Lillian_Rosanoff_Lieber) published *Modern Mathematics for T. C. Mits, The Celebrated Man in the Street*
- 1946 CE: [Lillian Rosanoff Lieber](https://en.wikipedia.org/wiki/Lillian_Rosanoff_Lieber) published *Take a Number: Mathematics for the Two Billion*
- 1947 CE: [Lillian Rosanoff Lieber](https://en.wikipedia.org/wiki/Lillian_Rosanoff_Lieber) published *Mits, Wits and Logic*
...
- 1948 CE: [John Bardeen](https://en.wikipedia.org/wiki/John_Bardeen), [Walter Brattain](https://en.wikipedia.org/wiki/Walter_Houser_Brattain) published *The Transistor, A Semiconductor Triode*, describing the [point-contact transistor](https://en.wikipedia.org/wiki/Point-contact_transistor) that they invented with [William Shockley](https://en.wikipedia.org/wiki/William_Shockley)
...
- 1948 CE: [Norbert Wiener](https://en.wikipedia.org/wiki/Norbert_Wiener) published [*Cybernetics: Or Control and Communication in the Animal and the Machine*](https://en.wikipedia.org/wiki/Cybernetics:_Or_Control_and_Communication_in_the_Animal_and_the_Machine)
...
- 1950 CE: [V. Gordon Childe](https://en.wikipedia.org/wiki/V._Gordon_Childe) published *The [Urban Revolution](https://en.wikipedia.org/wiki/Urban_revolution)*, and *Prehistoric Migrations* which discussed [diffusionism](https://en.wikipedia.org/wiki/Trans-cultural_diffusion)
- 1950 CE: Marcellus Luther ("M. L.") Jacobs patented an [*Apparatus for fixing blade angulation of wind-driven multiblade propellers*](https://patents.google.com/patent/US2505969A/), to avoid failure in high winds
- 1950 CE: [Leo Szilard](https://en.wikipedia.org/wiki/Leo_Szilard) & [Aaron Novick](https://en.wikipedia.org/wiki/Aaron_Novick) published *Description of the [Chemostat](https://en.wikipedia.org/wiki/Chemostat)*, describing a bioreactor they invented
- 1950 CE: [Oskar Morgenstern](https://en.wikipedia.org/wiki/Oskar_Morgenstern) published *On the accuracy of economic observations*
- 1950 CE: [Norbert Wiener](https://en.wikipedia.org/wiki/Norbert_Wiener) published [*The Human Use of Human Beings*](https://en.wikipedia.org/wiki/The_Human_Use_of_Human_Beings)
- 1950 CE: [John Forbes Nash Jr.](https://en.wikipedia.org/wiki/John_Forbes_Nash_Jr.) published *Equilibrium Points in N-person Games* and *The Bargaining Problem*, contributing to [game theory](https://en.wikipedia.org/wiki/Game_theory)
- 1951 CE: [John Forbes Nash Jr.](https://en.wikipedia.org/wiki/John_Forbes_Nash_Jr.) published *Non-cooperative Games*, describing the [Nash equilibrium](https://en.wikipedia.org/wiki/Nash_equilibrium)
...
- 1951 CE: [John Bowlby](https://en.wikipedia.org/wiki/John_Bowlby) published [*Maternal Care and Mental Health*](https://en.wikipedia.org/wiki/Maternal_deprivation), laying the foundation for [attachment theory](https://en.wikipedia.org/wiki/Attachment_theory)
...
- 1953 CE: [Clair Cameron Patterson](https://en.wikipedia.org/wiki/Clair_Cameron_Patterson) developed one of the first [clean rooms](https://en.wikipedia.org/wiki/Cleanroom), to prevent lead contamination
...
- 1953 CE: [Alexander Grothendieck](https://en.wikipedia.org/wiki/Alexander_Grothendieck) published *Résumé de la théorie métrique des produits tensoriels topologiques* (*Summary of the metric theory of topological tensor products*), introducing the [Grothendieck inequality](https://en.wikipedia.org/wiki/Grothendieck_inequality)
- 1953 CE: [John Bowlby](https://en.wikipedia.org/wiki/John_Bowlby) published *Critical Phases in the Development of Social Responses in Man and Other Animals*, proposing a union of [psycholanalysis](https://en.wikipedia.org/wiki/Psychoanalysis) with [ethology](https://en.wikipedia.org/wiki/Ethology)
- 1953 CE: [Lillian Rosanoff Lieber](https://en.wikipedia.org/wiki/Lillian_Rosanoff_Lieber) published *Infinity: Beyond the Beyond the Beyond*
...
- 1954 CE: [Alexander Grothendieck](https://en.wikipedia.org/wiki/Alexander_Grothendieck) published *Topological vector spaces*
...
- 1955 CE: [Jean Dieudonné](https://en.wikipedia.org/wiki/Jean_Dieudonn%C3%A9) published *La Géométrie des groupes classiques* (*The geometry of classical groups*), introducing [Dieudonné modules](https://en.wikipedia.org/wiki/Dieudonn%C3%A9_module)
- 1955 CE: [Richard Feynman](https://en.wikipedia.org/wiki/Richard_Feynman) published [*The Value of Science*)](https://resolver.caltech.edu/CaltechES:19.3.Science)
...
- 1957 CE: [John Backus](https://en.wikipedia.org/wiki/John_Backus) and his team delivered the first [FORTRAN (Formula Translating System)](https://en.wikipedia.org/wiki/Fortran) compiler, the first [optimizing compiler](https://en.wikipedia.org/wiki/Optimizing_compiler) which allowed programmers to write code at a [higher level of abstraction](https://en.wikipedia.org/wiki/High-level_programming_language) than [assembly language](https://en.wikipedia.org/wiki/Assembly_language)
- 1957 CE: [Alexander Grothendieck](https://en.wikipedia.org/wiki/Alexander_Grothendieck) published [*Sur quelques points d'algèbre homologique* (*On some points of homological algebra*)](https://en.wikipedia.org/wiki/Grothendieck%27s_T%C3%B4hoku_paper), advancing [homological algebra](https://en.wikipedia.org/wiki/Homological_algebra) and introducing [Grothendieck categories](https://en.wikipedia.org/wiki/Grothendieck_category)
- 1957 CE: [Alexander Grothendieck](https://en.wikipedia.org/wiki/Alexander_Grothendieck) published *Classes de faisceaux et théorème de Riemann–Roch* (*Sheaf classes and the Riemann–Roch theorem*), proving the [Grothendieck–Riemann–Roch theorem](https://en.wikipedia.org/wiki/Grothendieck%E2%80%93Riemann%E2%80%93Roch_theorem), introducing the [Grothendieck group of differences](https://en.wikipedia.org/wiki/Grothendieck_group), and developing [*K*-theory](https://en.wikipedia.org/wiki/K-theory)
...
- 1958 CE: [Malcom McLean](https://en.wikipedia.org/wiki/Malcom_McLean) was granted [US patent 2853968](https://patents.google.com/patent/US2853968) for [intermodal freight containers](https://en.wikipedia.org/wiki/Intermodal_container)
...
- 1960 CE: [Charles David Keeling](https://en.wikipedia.org/wiki/Charles_David_Keeling) published *The Concentration and Isotopic Abundances of Carbon Dioxide in the Atmosphere*, showing that CO₂ levels vary seasonally
- 1961 CE: [Charles David Keeling](https://en.wikipedia.org/wiki/Charles_David_Keeling) published *The concentration and isotopic abundances of atmospheric carbon dioxide in rural and marine air*, showing that [CO₂ levels are increasing](https://en.wikipedia.org/wiki/Keeling_Curve)
...
- 1961 CE: [Lillian Rosanoff Lieber](https://en.wikipedia.org/wiki/Lillian_Rosanoff_Lieber) published *Human Values and Science, Art and Mathematics*
...
- 1962 CE: [Pyotr Ufimtsev](https://en.wikipedia.org/wiki/Pyotr_Ufimtsev) published *Method of Edge Waves in the Physical Theory of Diffraction*, describing how electromagnetic waves interact with surfaces and establishing the basis for stealth aircraft
- 1962 CE: [Pyotr Ufimtsev](https://en.wikipedia.org/wiki/Pyotr_Ufimtsev) published *Diffraction of plane electromagnetic waves by a thin cylindrical conductor*
- 1962 CE: [Everett Rogers](https://en.wikipedia.org/wiki/Everett_Rogers) published [*Diffusion of Innovations*](https://en.wikipedia.org/wiki/Diffusion_of_innovations)
...
- 1963 CE: [Peter Naur](https://en.wikipedia.org/wiki/Peter_Naur) published the [*Revised report on the algorithmic language ALGOL 60*](https://dl.acm.org/doi/10.1145/366193.366201), describing the syntax for [ALGOL 60 (Algorithmic Language 1960)](https://en.wikipedia.org/wiki/ALGOL_60) using [Backus–Naur form (BNF)](https://en.wikipedia.org/wiki/Backus%E2%80%93Naur_form), a [metasyntax](https://en.wikipedia.org/wiki/Metasyntax) for [context-free grammars](https://en.wikipedia.org/wiki/Context-free_grammar) originally proposed by [John Backus](https://en.wikipedia.org/wiki/John_Backus)
- 1963 CE: [Lillian Rosanoff Lieber](https://en.wikipedia.org/wiki/Lillian_Rosanoff_Lieber) published *Mathematics: First S-t-e-p-s*
- 1963 CE: The [United Nations (UN)](https://en.wikipedia.org/wiki/United_Nations) [Food and Agriculture Organization (FAO)](https://en.wikipedia.org/wiki/Food_and_Agriculture_Organization) & [World Health Organization (WHO)](https://en.wikipedia.org/wiki/World_Health_Organization) published the [*Codex Alimentarius* (*Food Code*)](https://en.wikipedia.org/wiki/Codex_Alimentarius_Austriacus), promoting food safety
- 1963 CE: [Paul Cohen](https://en.wikipedia.org/wiki/Paul_Cohen) published *The independence of the [continuum hypothesis](https://en.wikipedia.org/wiki/Continuum_hypothesis)*
- 1964 CE: [Paul Cohen](https://en.wikipedia.org/wiki/Paul_Cohen) published *The independence of the [continuum hypothesis](https://en.wikipedia.org/wiki/Continuum_hypothesis), II*
- 1964 CE: [Richard Feynman](https://en.wikipedia.org/wiki/Richard_Feynman) published [*The Feynman Lectures on Physics*](https://en.wikipedia.org/wiki/The_Feynman_Lectures_on_Physics)
...
- 1964 CE: [Norbert Wiener](https://en.wikipedia.org/wiki/Norbert_Wiener) published [*God & Golem, Inc.*](https://en.wikipedia.org/wiki/God_%26_Golem,_Inc.), discussing the place of machines in society, and arguing that politics should bear the burden of ethics
- 1965 CE: [Richard Feynman](https://en.wikipedia.org/wiki/Richard_Feynman) & [Albert Hibbs](https://en.wikipedia.org/wiki/Albert_Hibbs) published [*Quantum Mechanics and Path Integrals*](https://archive.org/details/quantummechanics0000feyn)
...
- 1965 CE: [Mary Ainsworth](https://en.wikipedia.org/wiki/Mary_Ainsworth) & [John Bowlby](https://en.wikipedia.org/wiki/John_Bowlby) published *Child Care and the Growth of Love*, advancing [attachment theory](https://en.wikipedia.org/wiki/Attachment_theory)
- 1966 CE: [John von Neumann](https://en.wikipedia.org/wiki/John_von_Neumann) published *Theory of Self-Reproducing Automata*
- 1966 CE: [Richard Feynman](https://en.wikipedia.org/wiki/Richard_Feynman) presented [*What Is Science?*](https://feynman.com/science/what-is-science/), on science education
- 1966 CE: [Richard Feynman](https://en.wikipedia.org/wiki/Richard_Feynman) presented *The Development of the Space-Time View of Quantum Electrodynamics*
...
- 1969 CE: [Martin Richards](https://en.wikipedia.org/wiki/Martin_Richards_%28computer_scientist%29) published [*BCPL: a tool for compiler writing and system programming*](https://dl.acm.org/doi/10.1145/1476793.1476880), describing [BCPL ("Basic Combined Programming Language")](https://en.wikipedia.org/wiki/BCPL)
...
- 1969 CE: [Ken Thompson](https://en.wikipedia.org/wiki/Ken_Thompson) & [Dennis Ritchie](https://en.wikipedia.org/wiki/Dennis_Ritchie) developed [the B programming language](https://en.wikipedia.org/wiki/B_%28programming_language%29), based on [BCPL](https://en.wikipedia.org/wiki/BCPL)
...
- 1970 CE: [Charles David Keeling](https://en.wikipedia.org/wiki/Charles_David_Keeling) published *Is Carbon Dioxide from Fossil Fuel Changing Man's Environment?*, warning about [climate change](https://en.wikipedia.org/wiki/Climate_change)
...
- 1971 CE: [Intel](https://en.wikipedia.org/wiki/Intel) introduced the [4004](https://en.wikipedia.org/wiki/Intel_4004) 4-bit CPU, on a 10 μm process node, demonstrating [large-scale integration (LSI)](https://en.wikipedia.org/wiki/Integrated_circuit#LSI)
...
- 1976 CE: [Imre Lakatos](https://en.wikipedia.org/wiki/Imre_Lakatos) published [*Proofs and Refutations*](https://en.wikipedia.org/wiki/Proofs_and_Refutations)
- 1976 CE: [David A. Moon](https://en.wikipedia.org/wiki/David_A._Moon), [Guy L. Steele Jr.](https://en.wikipedia.org/wiki/Guy_L._Steele_Jr.), & [Richard Stallman](https://en.wikipedia.org/wiki/Richard_Stallman) developed the [Emacs text editor (short for "editor macros")](https://en.wikipedia.org/wiki/Emacs)
...
- 1978 CE: [Robin Milner](https://en.wikipedia.org/wiki/Robin_Milner) published *A theory of type polymorphism in programming*, describing the [ML (Meta Language) programming language](https://en.wikipedia.org/wiki/ML_%28programming_language%29)
...
- 1980 CE: Dorothy M. Settle & [Clair Cameron Patterson](https://en.wikipedia.org/wiki/Clair_Cameron_Patterson) published *Lead in albacore: guide to lead pollution in Americans*
...
- 1984 CE: [Gerald Jay Sussman](https://en.wikipedia.org/wiki/Gerald_Jay_Sussman), [Hal Abelson](https://en.wikipedia.org/wiki/Hal_Abelson), & Julie Sussman published [Structure and Interpretation of Computer Programs (SICP)](https://en.wikipedia.org/wiki/Structure_and_Interpretation_of_Computer_Programs)
...
- 1985 CE: [Richard Stallman](https://en.wikipedia.org/wiki/Richard_Stallman) released the [GNU Emacs](https://en.wikipedia.org/wiki/GNU_Emacs) text editor as [open-source software](https://en.wikipedia.org/wiki/Open-source_software)
...
- 1986 CE: [Leonid Levin](https://en.wikipedia.org/wiki/Leonid_Levin) published *Average Case Complete Problems*, developing [average-case complexity](https://en.wikipedia.org/wiki/Average-case_complexity)
...
- 1991 CE: [Mount Pinatubo erupted](https://en.wikipedia.org/wiki/Mount_Pinatubo#1991_eruption) in the present day Philippines, with a [volcanic explosivity index (VEI)](https://en.wikipedia.org/wiki/Volcanic_explosivity_index) of 6
...
- 1992 CE: [Peter Naur](https://en.wikipedia.org/wiki/Peter_Naur) published *Computing: A Human Activity*
...
- 1995 CE: [Yukihiro Matsumoto](https://en.wikipedia.org/wiki/Yukihiro_Matsumoto) released the [Ruby programming language](https://en.wikipedia.org/wiki/Ruby_%28programming_language%29) as [open-source software](https://en.wikipedia.org/wiki/Open-source_software)
...
- 1997 CE: The [European Space Agency (ESA)](https://en.wikipedia.org/wiki/European_Space_Agency) published the [Hipparcos & Tycho-1 star catalogs](https://en.wikipedia.org/wiki/Hipparcos#Published_catalogues)
...
- 1998 CE: [Ericsson](https://en.wikipedia.org/wiki/Ericsson) released the [Erlang programming language](https://en.wikipedia.org/wiki/Erlang_%28programming_language%29), designed by [Joe Armstrong](https://en.wikipedia.org/wiki/Joe_Armstrong_%28programmer%29), Robert Virding, and Mike Williams, as [open-source software](https://en.wikipedia.org/wiki/Open-source_software)
...
- 2000 CE: The [European Space Agency (ESA)](https://en.wikipedia.org/wiki/European_Space_Agency) published the [Tycho-2 astronomical catalog](https://en.wikipedia.org/wiki/Tycho-2_Catalogue)
...
- 2003 CE: [Pyotr Ufimtsev](https://en.wikipedia.org/wiki/Pyotr_Ufimtsev) published *Theory of Edge Diffraction in Electromagnetics*
...
- 2005 CE: [Lorraine Lisiecki](https://en.wikipedia.org/wiki/Lorraine_Lisiecki) & [Maureen Raymo](https://en.wikipedia.org/wiki/Maureen_Raymo) published *A Pliocene-Pleistocene stack of 57 globally distributed benthic D 18 O records*, a.k.a. the *Lisiecki-Raymo [δ18O](https://en.wikipedia.org/wiki/%CE%9418O) stack* showing the [past 5 million years of climate data](https://commons.wikimedia.org/wiki/File:Five_Myr_Climate_Change.svg)
- 2005 CE: [John Ioannidis](https://en.wikipedia.org/wiki/John_Ioannidis) published [*Why Most Published Research Findings Are False*](https://en.wikipedia.org/wiki/Why_Most_Published_Research_Findings_Are_False), calling attention to the [replication crisis](https://en.wikipedia.org/wiki/Replication_crisis)
- 2005 CE: [Katalin Karikó](https://en.wikipedia.org/wiki/Katalin_Karik%C3%B3), Michael Buckstein, Houping Ni, and [Drew Weissman](https://en.wikipedia.org/wiki/Drew_Weissman) published *Suppression of RNA recognition by Toll-like receptors: the impact of nucleoside modification and the evolutionary origin of RNA*, describing how to avoid an immune response to [mRNA vaccines](https://en.wikipedia.org/wiki/MRNA_vaccine)
...
- 2007 CE: [Pyotr Ufimtsev](https://en.wikipedia.org/wiki/Pyotr_Ufimtsev) published *Fundamentals of the Physical Theory of Diffraction*
...
- 2009 CE: [Ryan Dahl](https://en.wikipedia.org/wiki/Ryan_Dahl) published [Node.js](https://en.wikipedia.org/wiki/Node.js), a JavaScript runtime, as [open-source software](https://en.wikipedia.org/wiki/Open-source_software)
...
- 2012 CE: [Jennifer Doudna](https://en.wikipedia.org/wiki/Jennifer_Doudna), [Emmanuelle Charpentier](https://en.wikipedia.org/wiki/Emmanuelle_Charpentier) et al. published *A Programmable Dual-RNA–Guided DNA Endonuclease in Adaptive Bacterial Immunity*, describing [CRISPR](https://en.wikipedia.org/wiki/CRISPR)
- 2013 CE: Monthly average CO₂ exceeded 400 ppm
- 2013 CE: [Tomáš Mikolov](https://en.wikipedia.org/wiki/Tom%C3%A1%C5%A1_Mikolov), Kai Chen, [Greg Corrado](https://en.wikipedia.org/wiki/Greg_Corrado), [Ilya Sutskever](https://en.wikipedia.org/wiki/Ilya_Sutskever), and [Jeff Dean](https://en.wikipedia.org/wiki/Jeff_Dean) developed [word2vec](https://en.wikipedia.org/wiki/Word2vec), which encodes word meanings as vectors, and published both *Efficient Estimation of Word Representations in Vector Space* and *Distributed representations of words and phrases and their compositionality*
- 2014 CE: [Lê Viết Quốc](https://en.wikipedia.org/wiki/Quoc_V._Le) developed [seq2seq](https://en.wikipedia.org/wiki/Seq2seq), and published *Sequence to sequence learning with neural networks* with [Ilya Sutskever](https://en.wikipedia.org/wiki/Ilya_Sutskever) and [Oriol Vinyals](https://en.wikipedia.org/wiki/Oriol_Vinyals)
...
- 2020 CE: Julian Schrittwieser et al. published *Mastering Atari, Go, chess and shogi by planning with a learned model*, describing [MuZero](https://en.wikipedia.org/wiki/MuZero)
...
- [Lists of publications in science](https://en.wikipedia.org/wiki/Lists_of_publications_in_science)
  ...
  - [List of publications in chemistry](https://en.wikipedia.org/wiki/List_of_publications_in_chemistry)
  - [List of publications in data science](https://en.wikipedia.org/wiki/List_of_publications_in_data_science)
  - [List of publications in economics](https://en.wikipedia.org/wiki/List_of_publications_in_economics)
  - [List of publications in mathematics](https://en.wikipedia.org/wiki/List_of_publications_in_mathematics)
  - [List of publications in medicine](https://en.wikipedia.org/wiki/List_of_publications_in_medicine)
  - [List of publications in philosophy](https://en.wikipedia.org/wiki/List_of_publications_in_philosophy)
  - [List of publications in physics](https://en.wikipedia.org/wiki/List_of_publications_in_physics)
...
- [History of mathematics](https://en.wikipedia.org/wiki/History_of_mathematics)
  ...
  - [History of combinatorics](https://en.wikipedia.org/wiki/History_of_combinatorics)
  - [History of geometry](https://en.wikipedia.org/wiki/History_of_geometry)
...
- [History of medicine](https://en.wikipedia.org/wiki/History_of_medicine)
  ...
  - [History of anatomy](https://en.wikipedia.org/wiki/History_of_anatomy)
  ...
  - [History of surgery](https://en.wikipedia.org/wiki/History_of_surgery)
