...
- 1912 CE: [Victor Hess](https://en.wikipedia.org/wiki/Victor_Francis_Hess) published *Über Beobachtungen der durchdringenden Strahlung bei sieben Freiballonfahrten* (*About observations of the penetrating radiation during seven free balloon trips*), describing [cosmic rays](https://en.wikipedia.org/wiki/Cosmic_ray)
