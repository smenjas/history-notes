...
- 782-796 CE: [Alcuin of York](https://en.wikipedia.org/wiki/Alcuin) developed [Carolingian minuscule](https://en.wikipedia.org/wiki/Carolingian_minuscule) from [Roman half uncial](Roman half uncial) & [Irish insular](https://en.wikipedia.org/wiki/Insular_script) scripts, introducing lowercase letters, which improved legibility
...
- 1545 CE: [Gerolamo Cardano](https://en.wikipedia.org/wiki/Gerolamo_Cardano) published [*Ars Magna* (*The Great Art*)](https://en.wikipedia.org/wiki/Ars_Magna_%28Cardano_book%29), with soutions to [cubic](https://en.wikipedia.org/wiki/Cubic_equation) & [quartic equations](https://en.wikipedia.org/wiki/Quartic_equation), and demonstrating [negative](https://en.wikipedia.org/wiki/Negative_numbers) & [imaginary numbers](https://en.wikipedia.org/wiki/Imaginary_number)
...
- 1729 CE: [James Bradley](https://en.wikipedia.org/wiki/James_Bradley) described the [aberration of light](https://en.wikipedia.org/wiki/Aberration_%28astronomy%29), confirming the [heliocentric model](https://en.wikipedia.org/wiki/Heliocentrism) proposed by [Aristarchus](https://en.wikipedia.org/wiki/Aristarchus_of_Samos) & [Johannes Kepler](https://en.wikipedia.org/wiki/Johannes_Kepler)
...
- 1748 CE: [James Bradley](https://en.wikipedia.org/wiki/James_Bradley) described the [nutation of the Earth's axis](https://en.wikipedia.org/wiki/Astronomical_nutation)
