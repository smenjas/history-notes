...
- 1969 CE: [Martin Richards](https://en.wikipedia.org/wiki/Martin_Richards_%28computer_scientist_%29) published [*BCPL: a tool for compiler writing and system programming*](https://dl.acm.org/doi/10.1145/1476793.1476880), describing [BCPL ("Basic Combined Programming Language")](https://en.wikipedia.org/wiki/BCPL)
...
- 1978 CE: [Robin Milner](https://en.wikipedia.org/wiki/Robin_Milner) published *A theory of type polymorphism in programming*, describing the [ML (Meta Language) programming language](https://en.wikipedia.org/wiki/ML_%28programming_language_%29)
